...
static ValaDataType* vala_interface_type_real_copy (ValaDataType* base) {
	...
	_result_ = vala_interface_type_new (self->priv->_interface_symbol);
...
static char* vala_interface_type_real_get_cname (ValaDataType* base) {
	...
	char* _tmp1_;
	self = (ValaInterfaceType*) base;
	result = (_tmp1_ = g_strdup_printf ("%sIface*", _tmp0_ = vala_typesymbol_get_cname ((ValaTypeSymbol*) self->priv->_interface_symbol, FALSE)), _g_free0 (_tmp0_), _tmp1_);
	return result;
}
...
ValaInterface* vala_interface_type_get_interface_symbol (ValaInterfaceType* self) {
	...
	result = self->priv->_interface_symbol;
	return result;
}
