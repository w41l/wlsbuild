...
( cd etc/openrc/runlevels/sysinit ; rm -rf hwclock )
( cd etc/openrc/runlevels/sysinit ; ln -sf /etc/openrc/init.d/hwclock hwclock )
( cd etc/openrc/runlevels/sysinit ; rm -rf localmount )
( cd etc/openrc/runlevels/sysinit ; ln -sf /etc/openrc/init.d/localmount localmount )
( cd etc/openrc/runlevels/sysinit ; rm -rf modules )
( cd etc/openrc/runlevels/sysinit ; ln -sf /etc/openrc/init.d/modules modules )
( cd etc/openrc/runlevels/sysinit ; rm -rf mtab )
( cd etc/openrc/runlevels/sysinit ; ln -sf /etc/openrc/init.d/mtab mtab )
( cd etc/openrc/runlevels/sysinit ; rm -rf procfs )
( cd etc/openrc/runlevels/sysinit ; ln -sf /etc/openrc/init.d/procfs procfs )
( cd etc/openrc/runlevels/sysinit ; rm -rf root )
( cd etc/openrc/runlevels/sysinit ; ln -sf /etc/openrc/init.d/root root )
( cd etc/openrc/runlevels/sysinit ; rm -rf swap )
( cd etc/openrc/runlevels/sysinit ; ln -sf /etc/openrc/init.d/swap swap )
...
( cd etc/openrc/runlevels/sysinit ; rm -rf tmpfiles.setup )
( cd etc/openrc/runlevels/sysinit ; ln -sf /etc/openrc/init.d/tmpfiles.setup tmpfiles.setup )
...
( cd etc/openrc/runlevels/boot ; ln -sf /etc/openrc/init.d/dmesg dmesg )
...
( cd etc/openrc/runlevels/boot ; rm -rf ldconfig )
( cd etc/openrc/runlevels/boot ; ln -sf /etc/openrc/init.d/ldconfig ldconfig )
...
( cd etc/openrc/runlevels/boot ; rm -rf numlock )
( cd etc/openrc/runlevels/boot ; ln -sf /etc/openrc/init.d/numlock numlock )
...
( cd etc/openrc/runlevels/boot ; rm -rf portmap )
( cd etc/openrc/runlevels/boot ; ln -sf /etc/openrc/init.d/portmap portmap )
( cd etc/openrc/runlevels/boot ; rm -rf rpc.statd )
( cd etc/openrc/runlevels/boot ; ln -sf /etc/openrc/init.d/rpc.statd rpc.statd )
...
( cd etc/openrc/runlevels/default ; ln -sf /etc/openrc/init.d/inetd inetd )
