...
static gboolean vala_tuple_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer);
...
static gboolean vala_tuple_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer) {
	...
	if (vala_code_context_get_profile (vala_semantic_analyzer_get_context (analyzer)) != VALA_PROFILE_DOVA) {
		vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), "tuples are not supported");
		vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
		result = FALSE;
		return result;
	}
	vala_expression_set_value_type ((ValaExpression*) self, (ValaDataType*) (_tmp2_ = vala_object_type_new ((ValaObjectTypeSymbol*) (_tmp1_ = VALA_CLASS (vala_scope_lookup (vala_symbol_get_scope (_tmp0_ = vala_scope_lookup (vala_symbol_get_scope ((ValaSymbol*) vala_code_context_get_root (vala_semantic_analyzer_get_context (analyzer))), "Dova")), "Tuple"))))));
	...
	vala_data_type_set_value_owned (vala_expression_get_value_type ((ValaExpression*) self), TRUE);
	{
		...
		while (TRUE) {
			...
			vala_data_type_add_type_argument (vala_expression_get_value_type ((ValaExpression*) self), _tmp3_ = vala_data_type_copy (vala_expression_get_value_type (expr)));
