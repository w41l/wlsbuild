...
static gboolean vala_reference_transfer_expression_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer) {
	...
	if (VALA_IS_MEMBER_ACCESS (vala_reference_transfer_expression_get_inner (self))) {
		...
		_tmp0_ = VALA_IS_ELEMENT_ACCESS (vala_reference_transfer_expression_get_inner (self));
	}
	if (!_tmp0_) {
		vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
	...
	if (!vala_data_type_is_disposable (vala_expression_get_value_type (vala_reference_transfer_expression_get_inner (self)))) {
		_tmp1_ = !VALA_IS_POINTER_TYPE (vala_expression_get_value_type (vala_reference_transfer_expression_get_inner (self)));
	} else {
		_tmp1_ = FALSE;
	}
	if (_tmp1_) {
	...
	if (VALA_IS_DELEGATE_TYPE (vala_expression_get_value_type (vala_reference_transfer_expression_get_inner (self)))) {
		vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
		vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), "Reference transfer not supported for delegates");
		result = FALSE;
		return result;
	}
	vala_expression_set_value_type ((ValaExpression*) self, _tmp2_ = vala_data_type_copy (vala_expression_get_value_type (vala_reference_transfer_expression_get_inner (self))));
...
static void vala_reference_transfer_expression_real_emit (ValaCodeNode* base, ValaCodeGenerator* codegen) {
	...
	vala_code_node_emit ((ValaCodeNode*) vala_reference_transfer_expression_get_inner (self), codegen);
