...
static char* vala_unary_expression_real_to_string (ValaCodeNode* base) {
	...
	char* _tmp2_;
	self = (ValaUnaryExpression*) base;
	result = (_tmp2_ = g_strconcat (_tmp0_ = vala_unary_expression_get_operator_string (self), _tmp1_ = vala_code_node_to_string ((ValaCodeNode*) self->priv->_inner), NULL), _g_free0 (_tmp1_), _g_free0 (_tmp0_), _tmp2_);
	return result;
}
...
static gboolean vala_unary_expression_real_is_constant (ValaExpression* base) {
	...
	if (self->priv->_operator == VALA_UNARY_OPERATOR_INCREMENT) {
		...
		_tmp0_ = self->priv->_operator == VALA_UNARY_OPERATOR_DECREMENT;
	}
	if (_tmp0_) {
		result = FALSE;
		return result;
	}
	result = vala_expression_is_constant (vala_unary_expression_get_inner (self));
	return result;
}
...
static gboolean vala_unary_expression_real_is_pure (ValaExpression* base) {
	...
	result = vala_expression_is_pure (vala_unary_expression_get_inner (self));
	return result;
}
...
static gboolean vala_unary_expression_is_integer_type (ValaUnaryExpression* self, ValaDataType* type) {
	...
	st = _vala_code_node_ref0 (VALA_STRUCT (vala_data_type_get_data_type (type)));
	result = vala_struct_is_integer_type (st);
	_vala_code_node_unref0 (st);
	return result;
}
...
static ValaMemberAccess* vala_unary_expression_find_member_access (ValaUnaryExpression* self, ValaExpression* expr) {
	...
	if (VALA_IS_MEMBER_ACCESS (expr)) {
		result = _vala_code_node_ref0 (VALA_MEMBER_ACCESS (expr));
		return result;
	}
	result = NULL;
	return result;
...
static gboolean vala_unary_expression_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer) {
	...
	if (self->priv->_operator == VALA_UNARY_OPERATOR_REF) {
		...
		_tmp0_ = self->priv->_operator == VALA_UNARY_OPERATOR_OUT;
	}
	if (_tmp0_) {
	...
	if (VALA_IS_FIELD_PROTOTYPE (vala_expression_get_value_type (vala_unary_expression_get_inner (self)))) {
		...
		char* _tmp2_;
		vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
		vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) vala_unary_expression_get_inner (self)), _tmp2_ = g_strdup_printf ("Access to instance member `%s' denied", _tmp1_ = vala_symbol_get_full_name (vala_expression_get_symbol_reference (vala_unary_expression_get_inner (self)))));
		_g_free0 (_tmp2_);
		_g_free0 (_tmp1_);
		result = FALSE;
		return result;
	...
	if (self->priv->_operator == VALA_UNARY_OPERATOR_PLUS) {
		...
		_tmp3_ = self->priv->_operator == VALA_UNARY_OPERATOR_MINUS;
	}
	if (_tmp3_) {
		if (!vala_unary_expression_is_numeric_type (self, vala_expression_get_value_type (vala_unary_expression_get_inner (self)))) {
			...
			char* _tmp5_;
			vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
			vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), _tmp5_ = g_strdup_printf ("Operator not supported for `%s'", _tmp4_ = vala_code_node_to_string ((ValaCodeNode*) vala_expression_get_value_type (vala_unary_expression_get_inner (self)))));
			_g_free0 (_tmp5_);
			_g_free0 (_tmp4_);
			result = FALSE;
			return result;
		...
		if (self->priv->_operator == VALA_UNARY_OPERATOR_LOGICAL_NEGATION) {
			if (!vala_data_type_compatible (vala_expression_get_value_type (vala_unary_expression_get_inner (self)), analyzer->bool_type)) {
				...
				char* _tmp7_;
				vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
				vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), _tmp7_ = g_strdup_printf ("Operator not supported for `%s'", _tmp6_ = vala_code_node_to_string ((ValaCodeNode*) vala_expression_get_value_type (vala_unary_expression_get_inner (self)))));
				_g_free0 (_tmp7_);
				_g_free0 (_tmp6_);
				result = FALSE;
				return result;
			...
			if (self->priv->_operator == VALA_UNARY_OPERATOR_BITWISE_COMPLEMENT) {
				...
				if (!vala_unary_expression_is_integer_type (self, vala_expression_get_value_type (vala_unary_expression_get_inner (self)))) {
					_tmp8_ = !VALA_IS_ENUM_VALUE_TYPE (vala_expression_get_value_type (vala_unary_expression_get_inner (self)));
				} else {
					_tmp8_ = FALSE;
				}
				if (_tmp8_) {
					...
					char* _tmp10_;
					vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
					vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), _tmp10_ = g_strdup_printf ("Operator not supported for `%s'", _tmp9_ = vala_code_node_to_string ((ValaCodeNode*) vala_expression_get_value_type (vala_unary_expression_get_inner (self)))));
					_g_free0 (_tmp10_);
					_g_free0 (_tmp9_);
					result = FALSE;
					return result;
				...
				if (self->priv->_operator == VALA_UNARY_OPERATOR_INCREMENT) {
					...
					_tmp11_ = self->priv->_operator == VALA_UNARY_OPERATOR_DECREMENT;
				}
				if (_tmp11_) {
					ValaMemberAccess* ma;
					...
					if (!vala_unary_expression_is_integer_type (self, vala_expression_get_value_type (vala_unary_expression_get_inner (self)))) {
						...
						char* _tmp13_;
						vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
						vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), _tmp13_ = g_strdup_printf ("Operator not supported for `%s'", _tmp12_ = vala_code_node_to_string ((ValaCodeNode*) vala_expression_get_value_type (vala_unary_expression_get_inner (self)))));
						_g_free0 (_tmp13_);
						_g_free0 (_tmp12_);
						result = FALSE;
						return result;
					...
					if (self->priv->_operator == VALA_UNARY_OPERATOR_INCREMENT) {
						_tmp14_ = VALA_BINARY_OPERATOR_PLUS;
					} else {
						_tmp14_ = VALA_BINARY_OPERATOR_MINUS;
					}
					bin = (_tmp16_ = vala_binary_expression_new (_tmp14_, (ValaExpression*) old_value, (ValaExpression*) (_tmp15_ = vala_integer_literal_new ("1", NULL)), vala_code_node_get_source_reference ((ValaCodeNode*) self)), _vala_code_node_unref0 (_tmp15_), _tmp16_);
					...
					vala_expression_set_target_type ((ValaExpression*) assignment, vala_expression_get_target_type ((ValaExpression*) self));
					vala_collection_add ((ValaCollection*) analyzer->replaced_nodes, (ValaCodeNode*) self);
					vala_code_node_replace_expression (vala_code_node_get_parent_node ((ValaCodeNode*) self), (ValaExpression*) self, (ValaExpression*) assignment);
					vala_code_node_check ((ValaCodeNode*) assignment, analyzer);
					result = TRUE;
					...
					if (self->priv->_operator == VALA_UNARY_OPERATOR_REF) {
						...
						_tmp17_ = self->priv->_operator == VALA_UNARY_OPERATOR_OUT;
					}
					if (_tmp17_) {
						...
						ea = _vala_code_node_ref0 ((_tmp18_ = vala_unary_expression_get_inner (self), VALA_IS_ELEMENT_ACCESS (_tmp18_) ? ((ValaElementAccess*) _tmp18_) : NULL));
						if (VALA_IS_FIELD (vala_expression_get_symbol_reference (vala_unary_expression_get_inner (self)))) {
							_tmp21_ = TRUE;
						} else {
							_tmp21_ = VALA_IS_FORMAL_PARAMETER (vala_expression_get_symbol_reference (vala_unary_expression_get_inner (self)));
						}
						if (_tmp21_) {
							_tmp20_ = TRUE;
						} else {
							_tmp20_ = VALA_IS_LOCAL_VARIABLE (vala_expression_get_symbol_reference (vala_unary_expression_get_inner (self)));
						}
						if (_tmp20_) {
							_tmp19_ = TRUE;
						} else {
							...
							if (ea != NULL) {
								_tmp22_ = VALA_IS_ARRAY_TYPE (vala_expression_get_value_type (vala_element_access_get_container (ea)));
							} else {
								_tmp22_ = FALSE;
							}
							_tmp19_ = _tmp22_;
						...
						if (_tmp19_) {
							...
							vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
							vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), "ref and out method arguments can only be used with fields, parameters," \
...
static void vala_unary_expression_real_emit (ValaCodeNode* base, ValaCodeGenerator* codegen) {
	...
	vala_code_node_emit ((ValaCodeNode*) vala_unary_expression_get_inner (self), codegen);
...
static void vala_unary_expression_real_get_defined_variables (ValaCodeNode* base, ValaCollection* collection) {
	...
	if (self->priv->_operator == VALA_UNARY_OPERATOR_OUT) {
		...
		_tmp0_ = self->priv->_operator == VALA_UNARY_OPERATOR_REF;
	}
	if (_tmp0_) {
		ValaSymbol* _tmp1_;
		ValaLocalVariable* local;
		local = _vala_code_node_ref0 ((_tmp1_ = vala_expression_get_symbol_reference (vala_unary_expression_get_inner (self)), VALA_IS_LOCAL_VARIABLE (_tmp1_) ? ((ValaLocalVariable*) _tmp1_) : NULL));
		if (local != NULL) {
