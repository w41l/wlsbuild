/* valalistliteral.c generated by valac, the Vala compiler
 * generated from valalistliteral.vala, do not modify */
...
struct _ValaListLiteralPrivate {
...
static gpointer vala_list_literal_parent_class = NULL;
...
#define VALA_LIST_LITERAL_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), VALA_TYPE_LIST_LITERAL, ValaListLiteralPrivate))
enum  {
	VALA_LIST_LITERAL_DUMMY_PROPERTY
};
...
static void vala_list_literal_real_accept_children (ValaCodeNode* base, ValaCodeVisitor* visitor);
void vala_code_node_accept (ValaCodeNode* self, ValaCodeVisitor* visitor);
static void vala_list_literal_real_accept (ValaCodeNode* base, ValaCodeVisitor* visitor);
...
static gboolean vala_list_literal_real_is_pure (ValaExpression* base);
static void vala_list_literal_real_replace_expression (ValaCodeNode* base, ValaExpression* old_node, ValaExpression* new_node);
static gboolean vala_list_literal_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer);
...
static void vala_list_literal_set_element_type (ValaListLiteral* self, ValaDataType* value);
...
static void vala_list_literal_real_emit (ValaCodeNode* base, ValaCodeGenerator* codegen);
void vala_code_node_emit (ValaCodeNode* self, ValaCodeGenerator* codegen);
static void vala_list_literal_finalize (ValaCodeNode* obj);



ValaListLiteral* vala_list_literal_construct (GType object_type, ValaSourceReference* source_reference) {
	ValaListLiteral* self = NULL;
	self = (ValaListLiteral*) vala_literal_construct (object_type);
...
ValaListLiteral* vala_list_literal_new (ValaSourceReference* source_reference) {
	return vala_list_literal_construct (VALA_TYPE_LIST_LITERAL, source_reference);
}


static void vala_list_literal_real_accept_children (ValaCodeNode* base, ValaCodeVisitor* visitor) {
	ValaListLiteral * self;
	self = (ValaListLiteral*) base;
...
static void vala_list_literal_real_accept (ValaCodeNode* base, ValaCodeVisitor* visitor) {
	...
	self = (ValaListLiteral*) base;
	g_return_if_fail (visitor != NULL);
	vala_code_visitor_visit_list_literal (visitor, self);
...
static gboolean vala_list_literal_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer) {
	...
	array_type = _vala_code_node_ref0 ((_tmp0_ = vala_expression_get_target_type ((ValaExpression*) self), VALA_IS_ARRAY_TYPE (_tmp0_) ? ((ValaArrayType*) _tmp0_) : NULL));
	if (array_type != NULL) {
	...
	if (_tmp1_) {
		...
		initializer = vala_initializer_list_new (vala_code_node_get_source_reference ((ValaCodeNode*) self));
		vala_expression_set_target_type ((ValaExpression*) initializer, vala_expression_get_target_type ((ValaExpression*) self));
		{
			ValaIterator* _expr_it;
			_expr_it = vala_iterable_iterator ((ValaIterable*) self->priv->expression_list);
			while (TRUE) {
				...
				expr = (ValaExpression*) vala_iterator_get (_expr_it);
				vala_initializer_list_append (initializer, expr);
				_vala_code_node_unref0 (expr);
			}
			_vala_collection_object_unref0 (_expr_it);
		}
		vala_collection_add ((ValaCollection*) analyzer->replaced_nodes, (ValaCodeNode*) self);
		vala_code_node_replace_expression (vala_code_node_get_parent_node ((ValaCodeNode*) self), (ValaExpression*) self, (ValaExpression*) initializer);
		result = vala_code_node_check ((ValaCodeNode*) initializer, analyzer);
		_vala_code_node_unref0 (initializer);
		_vala_code_node_unref0 (array_type);
		return result;
	}
	list_type = (_tmp4_ = vala_object_type_new ((ValaObjectTypeSymbol*) (_tmp3_ = VALA_CLASS (vala_scope_lookup (vala_symbol_get_scope (_tmp2_ = vala_scope_lookup (vala_symbol_get_scope ((ValaSymbol*) vala_code_context_get_root (vala_semantic_analyzer_get_context (analyzer))), "Dova")), "List")))), _vala_code_node_unref0 (_tmp3_), _vala_code_node_unref0 (_tmp2_), _tmp4_);
	vala_data_type_set_value_owned ((ValaDataType*) list_type, TRUE);
	fixed_element_type = FALSE;
	if (vala_expression_get_target_type ((ValaExpression*) self) != NULL) {
		_tmp6_ = vala_data_type_get_data_type (vala_expression_get_target_type ((ValaExpression*) self)) == vala_data_type_get_data_type ((ValaDataType*) list_type);
	} else {
		_tmp6_ = FALSE;
	}
	if (_tmp6_) {
		ValaList* _tmp7_;
		_tmp5_ = vala_collection_get_size ((ValaCollection*) (_tmp7_ = vala_data_type_get_type_arguments (vala_expression_get_target_type ((ValaExpression*) self)))) == 1;
	...
	if (_tmp5_) {
		...
		vala_list_literal_set_element_type (self, _tmp10_ = vala_data_type_copy (_tmp9_ = (ValaDataType*) vala_list_get (_tmp8_ = vala_data_type_get_type_arguments (vala_expression_get_target_type ((ValaExpression*) self)), 0)));
	...
	}
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				expr = (_tmp12_ = (ValaExpression*) vala_list_get (self->priv->expression_list, i), _vala_code_node_unref0 (expr), _tmp12_);
				if (self->priv->_element_type == NULL) {
					ValaDataType* _tmp13_;
					vala_list_literal_set_element_type (self, _tmp13_ = vala_data_type_copy (vala_expression_get_value_type (expr)));
	...
	vala_list_literal_set_element_type (self, _tmp14_ = vala_data_type_copy (self->priv->_element_type));
	_vala_code_node_unref0 (_tmp14_);
	vala_data_type_set_value_owned (self->priv->_element_type, TRUE);
	vala_data_type_add_type_argument ((ValaDataType*) list_type, self->priv->_element_type);
	vala_expression_set_value_type ((ValaExpression*) self, (ValaDataType*) list_type);
	result = !vala_code_node_get_error ((ValaCodeNode*) self);
	_vala_code_node_unref0 (list_type);
	_vala_code_node_unref0 (array_type);
	return result;
...
static void vala_list_literal_real_emit (ValaCodeNode* base, ValaCodeGenerator* codegen) {
	...
	vala_code_visitor_visit_list_literal ((ValaCodeVisitor*) codegen, self);
...
static void vala_list_literal_class_init (ValaListLiteralClass * klass) {
	vala_list_literal_parent_class = g_type_class_peek_parent (klass);
	VALA_CODE_NODE_CLASS (klass)->finalize = vala_list_literal_finalize;
	g_type_class_add_private (klass, sizeof (ValaListLiteralPrivate));
	VALA_CODE_NODE_CLASS (klass)->accept_children = vala_list_literal_real_accept_children;
	VALA_CODE_NODE_CLASS (klass)->accept = vala_list_literal_real_accept;
	VALA_EXPRESSION_CLASS (klass)->is_pure = vala_list_literal_real_is_pure;
	VALA_CODE_NODE_CLASS (klass)->replace_expression = vala_list_literal_real_replace_expression;
	VALA_CODE_NODE_CLASS (klass)->check = vala_list_literal_real_check;
	VALA_CODE_NODE_CLASS (klass)->emit = vala_list_literal_real_emit;
}


static void vala_list_literal_instance_init (ValaListLiteral * self) {
	self->priv = VALA_LIST_LITERAL_GET_PRIVATE (self);
...
static void vala_list_literal_finalize (ValaCodeNode* obj) {
	ValaListLiteral * self;
	self = VALA_LIST_LITERAL (obj);
	_vala_collection_object_unref0 (self->priv->expression_list);
	_vala_code_node_unref0 (self->priv->_element_type);
	VALA_CODE_NODE_CLASS (vala_list_literal_parent_class)->finalize (obj);
}


GType vala_list_literal_get_type (void) {
	static volatile gsize vala_list_literal_type_id__volatile = 0;
	if (g_once_init_enter (&vala_list_literal_type_id__volatile)) {
		static const GTypeInfo g_define_type_info = { sizeof (ValaListLiteralClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) vala_list_literal_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValaListLiteral), 0, (GInstanceInitFunc) vala_list_literal_instance_init, NULL };
		GType vala_list_literal_type_id;
		vala_list_literal_type_id = g_type_register_static (VALA_TYPE_LITERAL, "ValaListLiteral", &g_define_type_info, 0);
		g_once_init_leave (&vala_list_literal_type_id__volatile, vala_list_literal_type_id);
	}
	return vala_list_literal_type_id__volatile;
}
