...
static char* vala_constant_real_get_default_cname (ValaConstant* self);
...
static void vala_constant_real_accept_children (ValaCodeNode* base, ValaCodeVisitor* visitor) {
	...
	if (vala_constant_get_value (self) != NULL) {
		vala_code_node_accept ((ValaCodeNode*) vala_constant_get_value (self), visitor);
	}
}
...
char* vala_constant_get_cname (ValaConstant* self) {
	...
	if (self->priv->cname == NULL) {
		char* _tmp0_;
		self->priv->cname = (_tmp0_ = vala_constant_get_default_cname (self), _g_free0 (self->priv->cname), _tmp0_);
	}
...
static char* vala_constant_real_get_default_cname (ValaConstant* self) {
	...
	if (vala_symbol_get_parent_symbol ((ValaSymbol*) self) == NULL) {
		...
		char* _tmp1_;
		char* _tmp2_;
		result = (_tmp2_ = g_strdup_printf ("%s%s", _tmp1_ = g_utf8_strup (_tmp0_ = vala_symbol_get_lower_case_cprefix (vala_symbol_get_parent_symbol ((ValaSymbol*) self)), -1), vala_symbol_get_name ((ValaSymbol*) self)), _g_free0 (_tmp1_), _g_free0 (_tmp0_), _tmp2_);
		return result;
	}
}
...
char* vala_constant_get_default_cname (ValaConstant* self) {
	return VALA_CONSTANT_GET_CLASS (self)->get_default_cname (self);
}
...
void vala_constant_set_cname (ValaConstant* self, const char* value) {
	...
	self->priv->cname = (_tmp0_ = g_strdup (value), _g_free0 (self->priv->cname), _tmp0_);
}
...
static void vala_constant_real_replace_expression (ValaCodeNode* base, ValaExpression* old_node, ValaExpression* new_node) {
	...
	if (vala_constant_get_value (self) == old_node) {
...
static void vala_constant_process_ccode_attribute (ValaConstant* self, ValaAttribute* a) {
	...
	if (vala_attribute_has_argument (a, "cname")) {
		char* _tmp0_;
		self->priv->cname = (_tmp0_ = vala_attribute_get_string (a, "cname"), _g_free0 (self->priv->cname), _tmp0_);
	}
...
static gboolean vala_constant_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer) {
	...
	if (!vala_constant_check_const_type (self, vala_constant_get_type_reference (self), analyzer)) {
		char* _tmp0_;
		char* _tmp1_;
		vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
		vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), _tmp1_ = g_strdup_printf ("`%s' not supported as type for constants", _tmp0_ = vala_code_node_to_string ((ValaCodeNode*) vala_constant_get_type_reference (self))));
		_g_free0 (_tmp1_);
		_g_free0 (_tmp0_);
		result = FALSE;
	...
	if (!vala_symbol_get_external ((ValaSymbol*) self)) {
		if (vala_constant_get_value (self) == NULL) {
			vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
			vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), "A const field requires a value to be provided");
		} else {
			vala_expression_set_target_type (vala_constant_get_value (self), vala_constant_get_type_reference (self));
			vala_code_node_check ((ValaCodeNode*) vala_constant_get_value (self), analyzer);
			if (!vala_data_type_compatible (vala_expression_get_value_type (vala_constant_get_value (self)), vala_constant_get_type_reference (self))) {
				char* _tmp2_;
				char* _tmp3_;
				char* _tmp4_;
				vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
				vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), _tmp4_ = g_strdup_printf ("Cannot convert from `%s' to `%s'", _tmp2_ = vala_code_node_to_string ((ValaCodeNode*) vala_expression_get_value_type (vala_constant_get_value (self))), _tmp3_ = vala_code_node_to_string ((ValaCodeNode*) vala_constant_get_type_reference (self))));
				_g_free0 (_tmp4_);
				_g_free0 (_tmp3_);
				_g_free0 (_tmp2_);
				result = FALSE;
		...
		if (vala_constant_get_value (self) != NULL) {
			vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
			vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), "External constants cannot use values");
		}
	}
	if (!vala_symbol_get_external_package ((ValaSymbol*) self)) {
		_tmp6_ = !vala_symbol_get_hides ((ValaSymbol*) self);
	} else {
		_tmp6_ = FALSE;
	}
	if (_tmp6_) {
		ValaSymbol* _tmp7_;
		_tmp5_ = (_tmp7_ = vala_symbol_get_hidden_member ((ValaSymbol*) self)) != NULL;
...
"intentional", _tmp8_ = vala_symbol_get_full_name ((ValaSymbol*) self), _tmp10_ = vala_symbol_get_full_name (_tmp9_ = vala_symbol_get_hidden_member ((ValaSymbol*) self))));
		_g_free0 (_tmp11_);
		_g_free0 (_tmp10_);
...
static gboolean vala_constant_check_const_type (ValaConstant* self, ValaDataType* type, ValaSemanticAnalyzer* analyzer) {
	...
	if (VALA_IS_VALUE_TYPE (type)) {
		...
		if (VALA_IS_ARRAY_TYPE (type)) {
			...
			result = vala_constant_check_const_type (self, vala_array_type_get_element_type (array_type), analyzer);
			_vala_code_node_unref0 (array_type);
			return result;
		} else {
			if (vala_data_type_get_data_type (type) == vala_data_type_get_data_type (analyzer->string_type)) {
				result = TRUE;
				return result;
			} else {
				result = FALSE;
...
void vala_constant_set_value (ValaConstant* self, ValaExpression* value) {
	...
	if (self->priv->_value != NULL) {
		vala_code_node_set_parent_node ((ValaCodeNode*) self->priv->_value, (ValaCodeNode*) self);
	}
}
...
static void vala_constant_class_init (ValaConstantClass * klass) {
	...
	VALA_CONSTANT_CLASS (klass)->get_default_cname = vala_constant_real_get_default_cname;
