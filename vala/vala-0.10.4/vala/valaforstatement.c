...
void vala_for_statement_add_initializer (ValaForStatement* self, ValaExpression* init) {
	...
	vala_collection_add ((ValaCollection*) self->priv->initializer, init);
}
...
ValaList* vala_for_statement_get_initializer (ValaForStatement* self) {
	...
	result = _vala_collection_object_ref0 (self->priv->initializer);
	return result;
}
...
void vala_for_statement_add_iterator (ValaForStatement* self, ValaExpression* iter) {
	...
	vala_collection_add ((ValaCollection*) self->priv->iterator, iter);
}
...
ValaList* vala_for_statement_get_iterator (ValaForStatement* self) {
	ValaList* result = NULL;
	g_return_val_if_fail (self != NULL, NULL);
	result = _vala_collection_object_ref0 (self->priv->iterator);
	return result;
}
...
static void vala_for_statement_real_accept_children (ValaCodeNode* base, ValaCodeVisitor* visitor) {
	...
	g_return_if_fail (visitor != NULL);
	{
		...
		while (TRUE) {
			...
			init_expr = (ValaExpression*) vala_iterator_get (_init_expr_it);
	...
	}
	{
		...
		while (TRUE) {
			...
			it_expr = (ValaExpression*) vala_iterator_get (_it_expr_it);
...
static gboolean vala_for_statement_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer) {
	...
	block = vala_block_new (vala_code_node_get_source_reference ((ValaCodeNode*) self));
	{
		...
		while (TRUE) {
			...
			init_expr = (ValaExpression*) vala_iterator_get (_init_expr_it);
			vala_block_add_statement (block, (ValaStatement*) (_tmp0_ = vala_expression_statement_new (init_expr, vala_code_node_get_source_reference ((ValaCodeNode*) init_expr))));
	...
	if (vala_for_statement_get_condition (self) == NULL) {
		...
		_tmp1_ = vala_for_statement_always_true (self, vala_for_statement_get_condition (self));
	}
	if (_tmp1_) {
	} else {
		if (vala_for_statement_always_false (self, vala_for_statement_get_condition (self))) {
			ValaBreakStatement* _tmp2_;
			vala_block_insert_statement (vala_for_statement_get_body (self), 0, (ValaStatement*) (_tmp2_ = vala_break_statement_new (vala_code_node_get_source_reference ((ValaCodeNode*) vala_for_statement_get_condition (self)))));
			...
			vala_block_add_statement (true_block, (ValaStatement*) (_tmp3_ = vala_break_statement_new (vala_code_node_get_source_reference ((ValaCodeNode*) vala_for_statement_get_condition (self)))));
	...
	first_local = (_tmp7_ = vala_local_variable_new (_tmp4_ = vala_data_type_copy (analyzer->bool_type), _tmp5_ = vala_code_node_get_temp_name (), (ValaExpression*) (_tmp6_ = vala_boolean_literal_new (TRUE, vala_code_node_get_source_reference ((ValaCodeNode*) self))), vala_code_node_get_source_reference ((ValaCodeNode*) self)), _vala_code_node_unref0 (_tmp6_), _g_free0 (_tmp5_), _vala_code_node_unref0 (_tmp4_), _tmp7_);
	vala_block_add_statement (block, (ValaStatement*) (_tmp8_ = vala_declaration_statement_new ((ValaSymbol*) first_local, vala_code_node_get_source_reference ((ValaCodeNode*) self))));
	_vala_code_node_unref0 (_tmp8_);
	iterator_block = vala_block_new (vala_code_node_get_source_reference ((ValaCodeNode*) self));
	{
		ValaIterator* _it_expr_it;
		_it_expr_it = vala_iterable_iterator ((ValaIterable*) self->priv->iterator);
		while (TRUE) {
			...
			it_expr = (ValaExpression*) vala_iterator_get (_it_expr_it);
			vala_block_add_statement (iterator_block, (ValaStatement*) (_tmp9_ = vala_expression_statement_new (it_expr, vala_code_node_get_source_reference ((ValaCodeNode*) it_expr))));
			_vala_code_node_unref0 (_tmp9_);
			_vala_code_node_unref0 (it_expr);
		}
		_vala_collection_object_unref0 (_it_expr_it);
	}
	first_if = (_tmp12_ = vala_if_statement_new ((ValaExpression*) (_tmp11_ = vala_unary_expression_new (VALA_UNARY_OPERATOR_LOGICAL_NEGATION, (ValaExpression*) (_tmp10_ = vala_member_access_new_simple (vala_symbol_get_name ((ValaSymbol*) first_local), vala_code_node_get_source_reference ((ValaCodeNode*) self))), vala_code_node_get_source_reference ((ValaCodeNode*) self))), iterator_block, NULL, vala_code_node_get_source_reference ((ValaCodeNode*) self)), _vala_code_node_unref0 (_tmp11_), _vala_code_node_unref0 (_tmp10_), _tmp12_);
	vala_block_insert_statement (vala_for_statement_get_body (self), 0, (ValaStatement*) first_if);
	vala_block_insert_statement (vala_for_statement_get_body (self), 1, (ValaStatement*) (_tmp16_ = vala_expression_statement_new ((ValaExpression*) (_tmp15_ = vala_assignment_new ((ValaExpression*) (_tmp13_ = vala_member_access_new_simple (vala_symbol_get_name ((ValaSymbol*) first_local), vala_code_node_get_source_reference ((ValaCodeNode*) self))), (ValaExpression*) (_tmp14_ = vala_boolean_literal_new (FALSE, vala_code_node_get_source_reference ((ValaCodeNode*) self))), VALA_ASSIGNMENT_OPERATOR_SIMPLE, vala_code_node_get_source_reference ((ValaCodeNode*) self))), vala_code_node_get_source_reference ((ValaCodeNode*) self))));
	_vala_code_node_unref0 (_tmp16_);
	_vala_code_node_unref0 (_tmp15_);
	_vala_code_node_unref0 (_tmp14_);
	_vala_code_node_unref0 (_tmp13_);
	vala_block_add_statement (block, (ValaStatement*) (_tmp17_ = vala_loop_new (vala_for_statement_get_body (self), vala_code_node_get_source_reference ((ValaCodeNode*) self))));
...
static void vala_for_statement_instance_init (ValaForStatement * self) {
	...
	self->priv->initializer = (ValaList*) vala_array_list_new (VALA_TYPE_EXPRESSION, (GBoxedCopyFunc) vala_code_node_ref, vala_code_node_unref, g_direct_equal);
	self->priv->iterator = (ValaList*) vala_array_list_new (VALA_TYPE_EXPRESSION, (GBoxedCopyFunc) vala_code_node_ref, vala_code_node_unref, g_direct_equal);
}
