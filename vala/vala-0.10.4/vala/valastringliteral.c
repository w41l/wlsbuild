...
char* vala_string_literal_eval (ValaStringLiteral* self) {
	...
	noquotes = string_substring (self->priv->_value, (glong) 1, (glong) ((guint) (string_get_length (self->priv->_value) - 2)));
	result = g_strcompress (noquotes);
	_g_free0 (noquotes);
	return result;
}
...
static gboolean vala_string_literal_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer) {
	...
	vala_expression_set_value_type ((ValaExpression*) self, _tmp0_ = vala_data_type_copy (analyzer->string_type));
