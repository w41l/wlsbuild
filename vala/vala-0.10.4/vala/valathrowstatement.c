...
static gboolean vala_throw_statement_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer) {
	...
	if (vala_code_context_get_profile (vala_semantic_analyzer_get_context (analyzer)) == VALA_PROFILE_GOBJECT) {
		...
		vala_expression_set_target_type (vala_throw_statement_get_error_expression (self), (ValaDataType*) (_tmp0_ = vala_error_type_new (NULL, NULL, vala_code_node_get_source_reference ((ValaCodeNode*) self))));
		_vala_code_node_unref0 (_tmp0_);
	} else {
		ValaDataType* _tmp1_;
		vala_expression_set_target_type (vala_throw_statement_get_error_expression (self), _tmp1_ = vala_data_type_copy (analyzer->error_type));
	...
	if (vala_throw_statement_get_error_expression (self) != NULL) {
		...
		if (!vala_code_node_check ((ValaCodeNode*) vala_throw_statement_get_error_expression (self), analyzer)) {
			vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
			result = FALSE;
			return result;
		}
		if (vala_expression_get_value_type (vala_throw_statement_get_error_expression (self)) == NULL) {
			vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) vala_throw_statement_get_error_expression (self)), "invalid error expression");
			vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
			result = FALSE;
			return result;
		}
		if (vala_code_context_get_profile (vala_semantic_analyzer_get_context (analyzer)) == VALA_PROFILE_GOBJECT) {
			_tmp2_ = !VALA_IS_ERROR_TYPE (vala_expression_get_value_type (vala_throw_statement_get_error_expression (self)));
		} else {
			_tmp2_ = FALSE;
		}
		if (_tmp2_) {
			char* _tmp3_;
			char* _tmp4_;
			vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) vala_throw_statement_get_error_expression (self)), _tmp4_ = g_strdup_printf ("`%s' is not an error type", _tmp3_ = vala_code_node_to_string ((ValaCodeNode*) vala_expression_get_value_type (vala_throw_statement_get_error_expression (self)))));
			_g_free0 (_tmp4_);
			_g_free0 (_tmp3_);
			vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
			result = FALSE;
...
static void vala_throw_statement_real_emit (ValaCodeNode* base, ValaCodeGenerator* codegen) {
	...
	if (vala_throw_statement_get_error_expression (self) != NULL) {
		vala_code_node_emit ((ValaCodeNode*) vala_throw_statement_get_error_expression (self), codegen);
		vala_code_visitor_visit_end_full_expression ((ValaCodeVisitor*) codegen, vala_throw_statement_get_error_expression (self));
	}
...
ValaExpression* vala_throw_statement_get_error_expression (ValaThrowStatement* self) {
	...
	result = self->priv->_error_expression;
	return result;
}
...
void vala_throw_statement_set_error_expression (ValaThrowStatement* self, ValaExpression* value) {
	...
	self->priv->_error_expression = (_tmp0_ = _vala_code_node_ref0 (value), _vala_code_node_unref0 (self->priv->_error_expression), _tmp0_);
