...
static char* vala_character_literal_real_to_string (ValaCodeNode* base);
static gboolean vala_character_literal_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer);
...
gunichar vala_character_literal_get_char (ValaCharacterLiteral* self) {
	...
	result = g_utf8_get_char (g_utf8_next_char (vala_character_literal_get_value (self)));
	return result;
}
...
static char* vala_character_literal_real_to_string (ValaCodeNode* base) {
	...
	char* result = NULL;
	self = (ValaCharacterLiteral*) base;
	result = g_strdup (vala_character_literal_get_value (self));
	return result;
}
...
static gboolean vala_character_literal_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer) {
	...
	if (vala_code_context_get_profile (vala_semantic_analyzer_get_context (analyzer)) == VALA_PROFILE_DOVA) {
		...
		vala_expression_set_value_type ((ValaExpression*) self, (ValaDataType*) (_tmp2_ = vala_integer_type_new (_tmp0_ = VALA_STRUCT (vala_scope_lookup (vala_symbol_get_scope (analyzer->root_symbol), "char")), _tmp1_ = g_unichar_to_string (vala_character_literal_get_char (self)), "int")));
		_vala_code_node_unref0 (_tmp2_);
		_g_free0 (_tmp1_);
		_vala_code_node_unref0 (_tmp0_);
	} else {
		if (vala_character_literal_get_char (self) < 128) {
			ValaStruct* _tmp3_;
			ValaIntegerType* _tmp4_;
			vala_expression_set_value_type ((ValaExpression*) self, (ValaDataType*) (_tmp4_ = vala_integer_type_new (_tmp3_ = VALA_STRUCT (vala_scope_lookup (vala_symbol_get_scope (analyzer->root_symbol), "char")), NULL, NULL)));
			_vala_code_node_unref0 (_tmp4_);
			_vala_code_node_unref0 (_tmp3_);
		} else {
			ValaStruct* _tmp5_;
			ValaIntegerType* _tmp6_;
			vala_expression_set_value_type ((ValaExpression*) self, (ValaDataType*) (_tmp6_ = vala_integer_type_new (_tmp5_ = VALA_STRUCT (vala_scope_lookup (vala_symbol_get_scope (analyzer->root_symbol), "unichar")), NULL, NULL)));
