...
static gboolean vala_do_statement_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer) {
	...
	if (vala_do_statement_always_true (self, vala_do_statement_get_condition (self))) {
		ValaLoop* loop;
		ValaBlock* parent_block;
		loop = vala_loop_new (vala_do_statement_get_body (self), vala_code_node_get_source_reference ((ValaCodeNode*) self));
	...
	first_local = (_tmp3_ = vala_local_variable_new (_tmp0_ = vala_data_type_copy (analyzer->bool_type), _tmp1_ = vala_code_node_get_temp_name (), (ValaExpression*) (_tmp2_ = vala_boolean_literal_new (TRUE, vala_code_node_get_source_reference ((ValaCodeNode*) self))), vala_code_node_get_source_reference ((ValaCodeNode*) self)), _vala_code_node_unref0 (_tmp2_), _g_free0 (_tmp1_), _vala_code_node_unref0 (_tmp0_), _tmp3_);
	vala_block_add_statement (block, (ValaStatement*) (_tmp4_ = vala_declaration_statement_new ((ValaSymbol*) first_local, vala_code_node_get_source_reference ((ValaCodeNode*) self))));
	...
	vala_block_add_statement (true_block, (ValaStatement*) (_tmp5_ = vala_break_statement_new (vala_code_node_get_source_reference ((ValaCodeNode*) vala_do_statement_get_condition (self)))));
	...
	first_if = (_tmp8_ = vala_if_statement_new ((ValaExpression*) (_tmp7_ = vala_unary_expression_new (VALA_UNARY_OPERATOR_LOGICAL_NEGATION, (ValaExpression*) (_tmp6_ = vala_member_access_new_simple (vala_symbol_get_name ((ValaSymbol*) first_local), vala_code_node_get_source_reference ((ValaCodeNode*) self))), vala_code_node_get_source_reference ((ValaCodeNode*) self))), condition_block, NULL, vala_code_node_get_source_reference ((ValaCodeNode*) self)), _vala_code_node_unref0 (_tmp7_), _vala_code_node_unref0 (_tmp6_), _tmp8_);
	vala_block_insert_statement (vala_do_statement_get_body (self), 0, (ValaStatement*) first_if);
	vala_block_insert_statement (vala_do_statement_get_body (self), 1, (ValaStatement*) (_tmp12_ = vala_expression_statement_new ((ValaExpression*) (_tmp11_ = vala_assignment_new ((ValaExpression*) (_tmp9_ = vala_member_access_new_simple (vala_symbol_get_name ((ValaSymbol*) first_local), vala_code_node_get_source_reference ((ValaCodeNode*) self))), (ValaExpression*) (_tmp10_ = vala_boolean_literal_new (FALSE, vala_code_node_get_source_reference ((ValaCodeNode*) self))), VALA_ASSIGNMENT_OPERATOR_SIMPLE, vala_code_node_get_source_reference ((ValaCodeNode*) self))), vala_code_node_get_source_reference ((ValaCodeNode*) self))));
	_vala_code_node_unref0 (_tmp12_);
	_vala_code_node_unref0 (_tmp11_);
	_vala_code_node_unref0 (_tmp10_);
	_vala_code_node_unref0 (_tmp9_);
	vala_block_add_statement (block, (ValaStatement*) (_tmp13_ = vala_loop_new (vala_do_statement_get_body (self), vala_code_node_get_source_reference ((ValaCodeNode*) self))));
