...
static void vala_ccode_comma_expression_real_write (ValaCCodeNode* base, ValaCCodeWriter* writer) {
	...
	vala_ccode_writer_write_string (writer, "(");
	{
		...
		_expr_it = vala_iterable_iterator ((ValaIterable*) self->priv->inner);
		while (TRUE) {
...
static void vala_ccode_comma_expression_instance_init (ValaCCodeCommaExpression * self) {
	...
	self->priv->inner = (ValaList*) vala_array_list_new (VALA_TYPE_CCODE_EXPRESSION, (GBoxedCopyFunc) vala_ccode_node_ref, vala_ccode_node_unref, g_direct_equal);
}
...
static void vala_ccode_comma_expression_finalize (ValaCCodeNode* obj) {
	...
	_vala_collection_object_unref0 (self->priv->inner);
