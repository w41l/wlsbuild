...
char* vala_real_literal_get_type_name (ValaRealLiteral* self) {
	...
	if (g_str_has_suffix (self->priv->_value, "f")) {
		...
		_tmp0_ = g_str_has_suffix (self->priv->_value, "F");
	}
	if (_tmp0_) {
...
static gboolean vala_real_literal_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer) {
	...
	st = (_tmp1_ = VALA_STRUCT (vala_scope_lookup (vala_symbol_get_scope (analyzer->root_symbol), _tmp0_ = vala_real_literal_get_type_name (self))), _g_free0 (_tmp0_), _tmp1_);
	vala_code_node_check ((ValaCodeNode*) st, analyzer);
	vala_expression_set_value_type ((ValaExpression*) self, (ValaDataType*) (_tmp2_ = vala_floating_type_new (st)));
