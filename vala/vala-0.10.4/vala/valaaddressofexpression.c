...
static gboolean vala_addressof_expression_real_is_pure (ValaExpression* base) {
	...
	self = (ValaAddressofExpression*) base;
	result = vala_expression_is_pure (vala_addressof_expression_get_inner (self));
	return result;
}
...
static gboolean vala_addressof_expression_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer) {
	...
	ea = _vala_code_node_ref0 ((_tmp0_ = vala_addressof_expression_get_inner (self), VALA_IS_ELEMENT_ACCESS (_tmp0_) ? ((ValaElementAccess*) _tmp0_) : NULL));
	if (VALA_IS_MEMBER_ACCESS (vala_addressof_expression_get_inner (self))) {
		_tmp1_ = VALA_IS_VARIABLE (vala_expression_get_symbol_reference (vala_addressof_expression_get_inner (self)));
	} else {
		_tmp1_ = FALSE;
	}
	if (_tmp1_) {
		...
		if (ea != NULL) {
			...
			if (VALA_IS_ARRAY_TYPE (vala_expression_get_value_type (vala_element_access_get_container (ea)))) {
				...
				_tmp3_ = VALA_IS_POINTER_TYPE (vala_expression_get_value_type (vala_element_access_get_container (ea)));
			}
			_tmp2_ = _tmp3_;
		} else {
			_tmp2_ = FALSE;
	...
	if (vala_data_type_is_reference_type_or_type_parameter (vala_expression_get_value_type (vala_addressof_expression_get_inner (self)))) {
		...
		vala_expression_set_value_type ((ValaExpression*) self, (ValaDataType*) (_tmp5_ = vala_pointer_type_new ((ValaDataType*) (_tmp4_ = vala_pointer_type_new (vala_expression_get_value_type (vala_addressof_expression_get_inner (self)), NULL)), NULL)));
		_vala_code_node_unref0 (_tmp5_);
		_vala_code_node_unref0 (_tmp4_);
	} else {
		ValaPointerType* _tmp6_;
		vala_expression_set_value_type ((ValaExpression*) self, (ValaDataType*) (_tmp6_ = vala_pointer_type_new (vala_expression_get_value_type (vala_addressof_expression_get_inner (self)), NULL)));
...
static void vala_addressof_expression_real_emit (ValaCodeNode* base, ValaCodeGenerator* codegen) {
	...
	vala_code_node_emit ((ValaCodeNode*) vala_addressof_expression_get_inner (self), codegen);
