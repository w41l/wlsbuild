...
static gboolean vala_typecheck_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer);
...
static void vala_typecheck_real_accept (ValaCodeNode* base, ValaCodeVisitor* visitor) {
	...
	vala_code_node_accept ((ValaCodeNode*) vala_typecheck_get_expression (self), visitor);
	vala_code_node_accept ((ValaCodeNode*) vala_typecheck_get_type_reference (self), visitor);
...
static gboolean vala_typecheck_real_is_pure (ValaExpression* base) {
	...
	self = (ValaTypeCheck*) base;
	result = vala_expression_is_pure (vala_typecheck_get_expression (self));
	return result;
}
...
static void vala_typecheck_real_replace_expression (ValaCodeNode* base, ValaExpression* old_node, ValaExpression* new_node) {
	...
	if (vala_typecheck_get_expression (self) == old_node) {
...
static gboolean vala_typecheck_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer) {
	...
	vala_code_node_check ((ValaCodeNode*) vala_typecheck_get_expression (self), analyzer);
	vala_code_node_check ((ValaCodeNode*) vala_typecheck_get_type_reference (self), analyzer);
	if (vala_data_type_get_data_type (vala_typecheck_get_type_reference (self)) == NULL) {
...
static void vala_typecheck_real_emit (ValaCodeNode* base, ValaCodeGenerator* codegen) {
	...
	vala_code_node_emit ((ValaCodeNode*) vala_typecheck_get_expression (self), codegen);
