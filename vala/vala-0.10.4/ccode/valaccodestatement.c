...
enum  {
	VALA_CCODE_STATEMENT_DUMMY_PROPERTY
};
...
static void vala_ccode_statement_class_init (ValaCCodeStatementClass * klass) {
	vala_ccode_statement_parent_class = g_type_class_peek_parent (klass);
}


static void vala_ccode_statement_instance_init (ValaCCodeStatement * self) {
}
