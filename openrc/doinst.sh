...
( cd etc/openrc/runlevels/boot ; rm -rf device-mapper )
( cd etc/openrc/runlevels/boot ; ln -sf /etc/openrc/init.d/device-mapper device-mapper )
...
( cd etc/openrc/runlevels/default ; rm -rf ntpd )
( cd etc/openrc/runlevels/default ; ln -sf /etc/openrc/init.d/ntpd ntpd )
