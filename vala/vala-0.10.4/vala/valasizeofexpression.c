...
static gboolean vala_sizeof_expression_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer);
...
static gboolean vala_sizeof_expression_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer) {
	...
	vala_code_node_check ((ValaCodeNode*) vala_sizeof_expression_get_type_reference (self), analyzer);
	vala_expression_set_value_type ((ValaExpression*) self, analyzer->ulong_type);
	result = !vala_code_node_get_error ((ValaCodeNode*) self);
	return result;
}
