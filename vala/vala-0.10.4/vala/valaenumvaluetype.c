...
static ValaSymbol* vala_enum_value_type_real_get_member (ValaDataType* base, const char* member_name) {
	...
	_result_ = VALA_DATA_TYPE_CLASS (vala_enum_value_type_parent_class)->get_member ((ValaDataType*) VALA_VALUE_TYPE (self), member_name);
	if (_result_ == NULL) {
		ValaCodeContext* _tmp0_;
		ValaSymbol* _tmp1_;
		ValaSymbol* _tmp2_;
		ValaSymbol* _tmp3_;
		_result_ = (_tmp3_ = vala_scope_lookup (vala_symbol_get_scope (_tmp2_ = vala_scope_lookup (vala_symbol_get_scope (_tmp1_ = vala_scope_lookup (vala_symbol_get_scope ((ValaSymbol*) vala_code_context_get_root (_tmp0_ = vala_code_context_get ())), "GLib")), "Enum")), member_name), _vala_code_node_unref0 (_result_), _tmp3_);
