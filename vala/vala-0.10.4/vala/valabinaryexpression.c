...
static gboolean vala_binary_expression_in_assert (ValaBinaryExpression* self);
...
static gboolean vala_binary_expression_pure_and_in_assert (ValaBinaryExpression* self);
...
static char* vala_binary_expression_real_to_string (ValaCodeNode* base) {
	...
	char* _tmp4_;
	self = (ValaBinaryExpression*) base;
	result = (_tmp4_ = g_strconcat (_tmp2_ = g_strconcat (_tmp0_ = vala_code_node_to_string ((ValaCodeNode*) self->priv->_left), _tmp1_ = vala_binary_expression_get_operator_string (self), NULL), _tmp3_ = vala_code_node_to_string ((ValaCodeNode*) self->priv->_right), NULL), _g_free0 (_tmp3_), _g_free0 (_tmp2_), _g_free0 (_tmp1_), _g_free0 (_tmp0_), _tmp4_);
	return result;
}
...
static gboolean vala_binary_expression_real_is_constant (ValaExpression* base) {
	...
	if (vala_expression_is_constant (vala_binary_expression_get_left (self))) {
		_tmp0_ = vala_expression_is_constant (vala_binary_expression_get_right (self));
	} else {
		_tmp0_ = FALSE;
	}
	result = _tmp0_;
...
static gboolean vala_binary_expression_real_is_pure (ValaExpression* base) {
	...
	if (vala_expression_is_pure (vala_binary_expression_get_left (self))) {
		_tmp0_ = vala_expression_is_pure (vala_binary_expression_get_right (self));
	} else {
		_tmp0_ = FALSE;
	}
	result = _tmp0_;
...
static gboolean vala_binary_expression_real_is_non_null (ValaExpression* base) {
	...
	if (vala_expression_is_non_null (vala_binary_expression_get_left (self))) {
		_tmp0_ = vala_expression_is_non_null (vala_binary_expression_get_right (self));
	} else {
		_tmp0_ = FALSE;
	}
	result = _tmp0_;
...
static gboolean vala_binary_expression_in_assert (ValaBinaryExpression* self) {
	...
	expr = _vala_code_node_ref0 ((ValaCodeNode*) self);
	while (TRUE) {
		gboolean _tmp0_ = FALSE;
		ValaCodeNode* _tmp2_;
		if (expr != NULL) {
			gboolean _tmp1_ = FALSE;
			if (VALA_IS_METHOD_CALL (expr)) {
				_tmp1_ = vala_method_call_get_is_assert (VALA_METHOD_CALL (expr));
			} else {
				_tmp1_ = FALSE;
			}
			_tmp0_ = !_tmp1_;
		...
		expr = (_tmp2_ = _vala_code_node_ref0 (vala_code_node_get_parent_node (expr)), _vala_code_node_unref0 (expr), _tmp2_);
	}
	result = expr != NULL;
...
static gboolean vala_binary_expression_pure_and_in_assert (ValaBinaryExpression* self) {
	...
	gboolean _tmp0_ = FALSE;
	g_return_val_if_fail (self != NULL, FALSE);
	if (vala_expression_is_pure ((ValaExpression*) self)) {
		_tmp0_ = vala_binary_expression_in_assert (self);
	} else {
		_tmp0_ = FALSE;
	}
	result = _tmp0_;
...
static gboolean vala_binary_expression_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer) {
	...
	if (VALA_IS_BLOCK (vala_semantic_analyzer_get_current_symbol (analyzer))) {
		_tmp1_ = !vala_binary_expression_pure_and_in_assert (self);
	} else {
		_tmp1_ = FALSE;
	}
	if (_tmp1_) {
		...
		if (self->priv->_operator == VALA_BINARY_OPERATOR_AND) {
			...
			_tmp2_ = self->priv->_operator == VALA_BINARY_OPERATOR_OR;
		}
		_tmp0_ = _tmp2_;
	} else {
		_tmp0_ = FALSE;
	...
	if (_tmp0_) {
		...
		ValaMemberAccess* ma;
		local = (_tmp5_ = vala_local_variable_new (_tmp3_ = vala_data_type_copy (analyzer->bool_type), _tmp4_ = vala_code_node_get_temp_name (), NULL, vala_code_node_get_source_reference ((ValaCodeNode*) self)), _g_free0 (_tmp4_), _vala_code_node_unref0 (_tmp3_), _tmp5_);
		...
		right_stmt = (_tmp8_ = vala_expression_statement_new ((ValaExpression*) (_tmp7_ = vala_assignment_new ((ValaExpression*) (_tmp6_ = vala_member_access_new_simple (vala_symbol_get_name ((ValaSymbol*) local), vala_code_node_get_source_reference ((ValaCodeNode*) vala_binary_expression_get_right (self)))), vala_binary_expression_get_right (self), VALA_ASSIGNMENT_OPERATOR_SIMPLE, vala_code_node_get_source_reference ((ValaCodeNode*) vala_binary_expression_get_right (self)))), vala_code_node_get_source_reference ((ValaCodeNode*) vala_binary_expression_get_right (self))), _vala_code_node_unref0 (_tmp7_), _vala_code_node_unref0 (_tmp6_), _tmp8_);
		stmt = (_tmp12_ = vala_expression_statement_new ((ValaExpression*) (_tmp11_ = vala_assignment_new ((ValaExpression*) (_tmp9_ = vala_member_access_new_simple (vala_symbol_get_name ((ValaSymbol*) local), vala_code_node_get_source_reference ((ValaCodeNode*) vala_binary_expression_get_left (self)))), (ValaExpression*) (_tmp10_ = vala_boolean_literal_new (self->priv->_operator == VALA_BINARY_OPERATOR_OR, vala_code_node_get_source_reference ((ValaCodeNode*) vala_binary_expression_get_left (self)))), VALA_ASSIGNMENT_OPERATOR_SIMPLE, vala_code_node_get_source_reference ((ValaCodeNode*) vala_binary_expression_get_left (self)))), vala_code_node_get_source_reference ((ValaCodeNode*) vala_binary_expression_get_left (self))), _vala_code_node_unref0 (_tmp11_), _vala_code_node_unref0 (_tmp10_), _vala_code_node_unref0 (_tmp9_), _tmp12_);
	...
	if (self->priv->_operator == VALA_BINARY_OPERATOR_COALESCE) {
		...
		ValaIfStatement* if_stmt;
		ValaMemberAccess* ma;
		local = (_tmp14_ = vala_local_variable_new (NULL, _tmp13_ = vala_code_node_get_temp_name (), vala_binary_expression_get_left (self), vala_code_node_get_source_reference ((ValaCodeNode*) self)), _g_free0 (_tmp13_), _tmp14_);
		decl = vala_declaration_statement_new ((ValaSymbol*) local, vala_code_node_get_source_reference ((ValaCodeNode*) self));
		vala_code_node_check ((ValaCodeNode*) decl, analyzer);
	...
	if (_tmp23_) {
		...
		if (vala_code_context_get_profile (vala_semantic_analyzer_get_context (analyzer)) == VALA_PROFILE_DOVA) {
			...
			concat_call = (_tmp25_ = vala_method_call_new ((ValaExpression*) (_tmp24_ = vala_member_access_new (vala_binary_expression_get_left (self), "concat", vala_code_node_get_source_reference ((ValaCodeNode*) self))), vala_code_node_get_source_reference ((ValaCodeNode*) self)), _vala_code_node_unref0 (_tmp24_), _tmp25_);
			vala_method_call_add_argument (concat_call, vala_binary_expression_get_right (self));
			vala_expression_set_target_type ((ValaExpression*) concat_call, vala_expression_get_target_type ((ValaExpression*) self));
			vala_code_node_replace_expression (vala_code_node_get_parent_node ((ValaCodeNode*) self), (ValaExpression*) self, (ValaExpression*) concat_call);
			result = vala_code_node_check ((ValaCodeNode*) concat_call, analyzer);
		...
		if (vala_expression_get_value_type (vala_binary_expression_get_right (self)) == NULL) {
			...
			_tmp26_ = vala_data_type_get_data_type (vala_expression_get_value_type (vala_binary_expression_get_right (self))) != vala_data_type_get_data_type (analyzer->string_type);
		}
		if (_tmp26_) {
			vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
		...
		vala_expression_set_value_type ((ValaExpression*) self, _tmp27_ = vala_data_type_copy (analyzer->string_type));
		_vala_code_node_unref0 (_tmp27_);
		if (vala_expression_is_constant (vala_binary_expression_get_left (self))) {
			_tmp28_ = vala_expression_is_constant (vala_binary_expression_get_right (self));
		} else {
			_tmp28_ = FALSE;
		}
		if (_tmp28_) {
		...
		if (vala_code_context_get_profile (vala_semantic_analyzer_get_context (analyzer)) == VALA_PROFILE_DOVA) {
			_tmp30_ = vala_data_type_get_data_type (vala_expression_get_value_type (vala_binary_expression_get_left (self))) == vala_data_type_get_data_type (analyzer->list_type);
		} else {
			_tmp30_ = FALSE;
		}
		if (_tmp30_) {
			_tmp29_ = self->priv->_operator == VALA_BINARY_OPERATOR_PLUS;
		} else {
			_tmp29_ = FALSE;
		}
		if (_tmp29_) {
			...
			ValaMethodCall* concat_call;
			concat_call = (_tmp32_ = vala_method_call_new ((ValaExpression*) (_tmp31_ = vala_member_access_new (vala_binary_expression_get_left (self), "concat", vala_code_node_get_source_reference ((ValaCodeNode*) self))), vala_code_node_get_source_reference ((ValaCodeNode*) self)), _vala_code_node_unref0 (_tmp31_), _tmp32_);
			vala_method_call_add_argument (concat_call, vala_binary_expression_get_right (self));
			vala_expression_set_target_type ((ValaExpression*) concat_call, vala_expression_get_target_type ((ValaExpression*) self));
			vala_code_node_replace_expression (vala_code_node_get_parent_node ((ValaCodeNode*) self), (ValaExpression*) self, (ValaExpression*) concat_call);
			result = vala_code_node_check ((ValaCodeNode*) concat_call, analyzer);
			...
			if (vala_code_context_get_profile (vala_semantic_analyzer_get_context (analyzer)) != VALA_PROFILE_DOVA) {
				_tmp34_ = VALA_IS_ARRAY_TYPE (vala_expression_get_value_type (vala_binary_expression_get_left (self)));
			} else {
				_tmp34_ = FALSE;
			}
			if (_tmp34_) {
				_tmp33_ = self->priv->_operator == VALA_BINARY_OPERATOR_PLUS;
			} else {
				_tmp33_ = FALSE;
			}
			if (_tmp33_) {
				...
				if (vala_expression_get_value_type (vala_binary_expression_get_right (self)) == NULL) {
					...
					_tmp35_ = !vala_data_type_compatible (vala_expression_get_value_type (vala_binary_expression_get_right (self)), vala_array_type_get_element_type (array_type));
				}
				if (_tmp35_) {
					vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
				...
				vala_expression_set_target_type (vala_binary_expression_get_right (self), _tmp36_ = vala_data_type_copy (vala_array_type_get_element_type (array_type)));
				_vala_code_node_unref0 (_tmp36_);
				vala_expression_set_value_type ((ValaExpression*) self, _tmp37_ = vala_data_type_copy ((ValaDataType*) array_type));
				...
				if (self->priv->_operator == VALA_BINARY_OPERATOR_PLUS) {
					...
					_tmp40_ = self->priv->_operator == VALA_BINARY_OPERATOR_MINUS;
				}
				if (_tmp40_) {
					_tmp39_ = TRUE;
				} else {
					_tmp39_ = self->priv->_operator == VALA_BINARY_OPERATOR_MUL;
				}
				if (_tmp39_) {
					_tmp38_ = TRUE;
				} else {
					_tmp38_ = self->priv->_operator == VALA_BINARY_OPERATOR_DIV;
				}
				if (_tmp38_) {
					if (VALA_IS_POINTER_TYPE (vala_expression_get_value_type (vala_binary_expression_get_left (self)))) {
						...
						offset_type = _vala_code_node_ref0 ((_tmp41_ = vala_data_type_get_data_type (vala_expression_get_value_type (vala_binary_expression_get_right (self))), VALA_IS_STRUCT (_tmp41_) ? ((ValaStruct*) _tmp41_) : NULL));
						if (offset_type != NULL) {
							_tmp42_ = vala_struct_is_integer_type (offset_type);
						} else {
							_tmp42_ = FALSE;
						}
						if (_tmp42_) {
							...
							if (self->priv->_operator == VALA_BINARY_OPERATOR_PLUS) {
								...
								_tmp43_ = self->priv->_operator == VALA_BINARY_OPERATOR_MINUS;
							}
							if (_tmp43_) {
								ValaDataType* _tmp44_;
								vala_expression_set_value_type ((ValaExpression*) self, _tmp44_ = vala_data_type_copy (vala_expression_get_value_type (vala_binary_expression_get_left (self))));
							...
							if (VALA_IS_POINTER_TYPE (vala_expression_get_value_type (vala_binary_expression_get_right (self)))) {
								if (vala_code_context_get_profile (vala_semantic_analyzer_get_context (analyzer)) == VALA_PROFILE_DOVA) {
									vala_expression_set_value_type ((ValaExpression*) self, analyzer->long_type);
								} else {
					...
					if (vala_expression_get_value_type ((ValaExpression*) self) == NULL) {
						...
						vala_expression_set_value_type ((ValaExpression*) self, _tmp45_ = vala_semantic_analyzer_get_arithmetic_result_type (analyzer, vala_expression_get_value_type (vala_binary_expression_get_left (self)), vala_expression_get_value_type (vala_binary_expression_get_right (self))));
					...
					if (vala_expression_get_value_type ((ValaExpression*) self) == NULL) {
						...
						char* _tmp48_;
						vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
						vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), _tmp48_ = g_strdup_printf ("Arithmetic operation not supported for types `%s' and `%s'", _tmp46_ = vala_code_node_to_string ((ValaCodeNode*) vala_expression_get_value_type (vala_binary_expression_get_left (self))), _tmp47_ = vala_code_node_to_string ((ValaCodeNode*) vala_expression_get_value_type (vala_binary_expression_get_right (self)))));
						_g_free0 (_tmp48_);
						_g_free0 (_tmp47_);
						_g_free0 (_tmp46_);
						result = FALSE;
					...
					if (self->priv->_operator == VALA_BINARY_OPERATOR_MOD) {
						...
						_tmp51_ = self->priv->_operator == VALA_BINARY_OPERATOR_SHIFT_LEFT;
					}
					if (_tmp51_) {
						_tmp50_ = TRUE;
					} else {
						_tmp50_ = self->priv->_operator == VALA_BINARY_OPERATOR_SHIFT_RIGHT;
					}
					if (_tmp50_) {
						_tmp49_ = TRUE;
					} else {
						_tmp49_ = self->priv->_operator == VALA_BINARY_OPERATOR_BITWISE_XOR;
					}
					if (_tmp49_) {
						ValaDataType* _tmp52_;
						vala_expression_set_value_type ((ValaExpression*) self, _tmp52_ = vala_semantic_analyzer_get_arithmetic_result_type (analyzer, vala_expression_get_value_type (vala_binary_expression_get_left (self)), vala_expression_get_value_type (vala_binary_expression_get_right (self))));
						...
						if (vala_expression_get_value_type ((ValaExpression*) self) == NULL) {
							...
							char* _tmp55_;
							vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
							vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), _tmp55_ = g_strdup_printf ("Arithmetic operation not supported for types `%s' and `%s'", _tmp53_ = vala_code_node_to_string ((ValaCodeNode*) vala_expression_get_value_type (vala_binary_expression_get_left (self))), _tmp54_ = vala_code_node_to_string ((ValaCodeNode*) vala_expression_get_value_type (vala_binary_expression_get_right (self)))));
							_g_free0 (_tmp55_);
							_g_free0 (_tmp54_);
							_g_free0 (_tmp53_);
							result = FALSE;
						...
						if (self->priv->_operator == VALA_BINARY_OPERATOR_LESS_THAN) {
							...
							_tmp58_ = self->priv->_operator == VALA_BINARY_OPERATOR_GREATER_THAN;
						}
						if (_tmp58_) {
							_tmp57_ = TRUE;
						} else {
							_tmp57_ = self->priv->_operator == VALA_BINARY_OPERATOR_LESS_THAN_OR_EQUAL;
						}
						if (_tmp57_) {
							_tmp56_ = TRUE;
						} else {
							_tmp56_ = self->priv->_operator == VALA_BINARY_OPERATOR_GREATER_THAN_OR_EQUAL;
						}
						if (_tmp56_) {
							...
							if (vala_data_type_compatible (vala_expression_get_value_type (vala_binary_expression_get_left (self)), analyzer->string_type)) {
								_tmp59_ = vala_data_type_compatible (vala_expression_get_value_type (vala_binary_expression_get_right (self)), analyzer->string_type);
							} else {
								_tmp59_ = FALSE;
							}
							if (_tmp59_) {
								...
								if (VALA_IS_POINTER_TYPE (vala_expression_get_value_type (vala_binary_expression_get_left (self)))) {
									_tmp60_ = VALA_IS_POINTER_TYPE (vala_expression_get_value_type (vala_binary_expression_get_right (self)));
								} else {
									_tmp60_ = FALSE;
								}
								if (_tmp60_) {
									...
									if (self->chained) {
										...
										lbe = _vala_code_node_ref0 (VALA_BINARY_EXPRESSION (vala_binary_expression_get_left (self)));
										resulting_type = (_tmp61_ = vala_semantic_analyzer_get_arithmetic_result_type (analyzer, vala_expression_get_value_type (vala_binary_expression_get_right (lbe)), vala_expression_get_value_type (vala_binary_expression_get_right (self))), _vala_code_node_unref0 (resulting_type), _tmp61_);
										_vala_code_node_unref0 (lbe);
									} else {
										ValaDataType* _tmp62_;
										resulting_type = (_tmp62_ = vala_semantic_analyzer_get_arithmetic_result_type (analyzer, vala_expression_get_value_type (vala_binary_expression_get_left (self)), vala_expression_get_value_type (vala_binary_expression_get_right (self))), _vala_code_node_unref0 (resulting_type), _tmp62_);
									}
									if (resulting_type == NULL) {
										...
										char* _tmp65_;
										vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
										vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), _tmp65_ = g_strdup_printf ("Relational operation not supported for types `%s' and `%s'", _tmp63_ = vala_code_node_to_string ((ValaCodeNode*) vala_expression_get_value_type (vala_binary_expression_get_left (self))), _tmp64_ = vala_code_node_to_string ((ValaCodeNode*) vala_expression_get_value_type (vala_binary_expression_get_right (self)))));
										_g_free0 (_tmp65_);
										_g_free0 (_tmp64_);
										_g_free0 (_tmp63_);
										result = FALSE;
									...
									vala_expression_set_target_type (vala_binary_expression_get_left (self), _tmp66_ = vala_data_type_copy (vala_expression_get_value_type (vala_binary_expression_get_left (self))));
									...
									vala_expression_set_target_type (vala_binary_expression_get_right (self), _tmp67_ = vala_data_type_copy (vala_expression_get_value_type (vala_binary_expression_get_right (self))));
							...
							if (self->priv->_operator == VALA_BINARY_OPERATOR_EQUALITY) {
								...
								_tmp68_ = self->priv->_operator == VALA_BINARY_OPERATOR_INEQUALITY;
							}
							if (_tmp68_) {
								...
								if (!vala_data_type_compatible (vala_expression_get_value_type (vala_binary_expression_get_right (self)), vala_expression_get_value_type (vala_binary_expression_get_left (self)))) {
									_tmp69_ = !vala_data_type_compatible (vala_expression_get_value_type (vala_binary_expression_get_left (self)), vala_expression_get_value_type (vala_binary_expression_get_right (self)));
								} else {
									_tmp69_ = FALSE;
								}
								if (_tmp69_) {
									...
									char* _tmp71_;
									char* _tmp72_;
									vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), _tmp72_ = g_strdup_printf ("Equality operation: `%s' and `%s' are incompatible", _tmp70_ = vala_code_node_to_string ((ValaCodeNode*) vala_expression_get_value_type (vala_binary_expression_get_right (self))), _tmp71_ = vala_code_node_to_string ((ValaCodeNode*) vala_expression_get_value_type (vala_binary_expression_get_left (self)))));
									_g_free0 (_tmp72_);
									_g_free0 (_tmp71_);
									_g_free0 (_tmp70_);
									vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
								...
								vala_expression_set_target_type (vala_binary_expression_get_left (self), _tmp73_ = vala_data_type_copy (vala_expression_get_value_type (vala_binary_expression_get_left (self))));
								_vala_code_node_unref0 (_tmp73_);
								vala_data_type_set_value_owned (vala_expression_get_target_type (vala_binary_expression_get_left (self)), FALSE);
								vala_expression_set_target_type (vala_binary_expression_get_right (self), _tmp74_ = vala_data_type_copy (vala_expression_get_value_type (vala_binary_expression_get_right (self))));
								...
								if (vala_data_type_compatible (vala_expression_get_value_type (vala_binary_expression_get_left (self)), analyzer->string_type)) {
									_tmp75_ = vala_data_type_compatible (vala_expression_get_value_type (vala_binary_expression_get_right (self)), analyzer->string_type);
								} else {
									_tmp75_ = FALSE;
								}
								if (_tmp75_) {
									if (vala_code_context_get_profile (vala_semantic_analyzer_get_context (analyzer)) == VALA_PROFILE_DOVA) {
										...
										ValaMethodCall* _tmp77_;
										ValaMethodCall* equals_call;
										string_ma = vala_member_access_new_simple ("string", vala_code_node_get_source_reference ((ValaCodeNode*) self));
										vala_member_access_set_qualified (string_ma, TRUE);
										equals_call = (_tmp77_ = vala_method_call_new ((ValaExpression*) (_tmp76_ = vala_member_access_new ((ValaExpression*) string_ma, "equals", vala_code_node_get_source_reference ((ValaCodeNode*) self))), vala_code_node_get_source_reference ((ValaCodeNode*) self)), _vala_code_node_unref0 (_tmp76_), _tmp77_);
										vala_method_call_add_argument (equals_call, vala_binary_expression_get_left (self));
								...
								if (self->priv->_operator == VALA_BINARY_OPERATOR_BITWISE_AND) {
									...
									_tmp78_ = self->priv->_operator == VALA_BINARY_OPERATOR_BITWISE_OR;
								}
								if (_tmp78_) {
									...
									if (self->priv->_operator == VALA_BINARY_OPERATOR_AND) {
										...
										_tmp79_ = self->priv->_operator == VALA_BINARY_OPERATOR_OR;
									}
									if (_tmp79_) {
										...
										if (!vala_data_type_compatible (vala_expression_get_value_type (vala_binary_expression_get_left (self)), analyzer->bool_type)) {
											...
											_tmp80_ = !vala_data_type_compatible (vala_expression_get_value_type (vala_binary_expression_get_right (self)), analyzer->bool_type);
										}
										if (_tmp80_) {
											vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
										...
										if (self->priv->_operator == VALA_BINARY_OPERATOR_IN) {
											...
											if (vala_data_type_compatible (vala_expression_get_value_type (vala_binary_expression_get_left (self)), analyzer->int_type)) {
												_tmp81_ = vala_data_type_compatible (vala_expression_get_value_type (vala_binary_expression_get_right (self)), analyzer->int_type);
											} else {
												_tmp81_ = FALSE;
											}
											if (_tmp81_) {
												...
												if (VALA_IS_ARRAY_TYPE (vala_expression_get_value_type (vala_binary_expression_get_right (self)))) {
													if (!vala_data_type_compatible (vala_expression_get_value_type (vala_binary_expression_get_left (self)), vala_array_type_get_element_type (VALA_ARRAY_TYPE (vala_expression_get_value_type (vala_binary_expression_get_right (self)))))) {
														...
														char* _tmp83_;
														char* _tmp84_;
														vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), _tmp84_ = g_strdup_printf ("Cannot look for `%s' in `%s'", _tmp82_ = vala_code_node_to_string ((ValaCodeNode*) vala_expression_get_value_type (vala_binary_expression_get_left (self))), _tmp83_ = vala_code_node_to_string ((ValaCodeNode*) vala_expression_get_value_type (vala_binary_expression_get_right (self)))));
														_g_free0 (_tmp84_);
														_g_free0 (_tmp83_);
														_g_free0 (_tmp82_);
													}
													...
													ValaMethodCall* _tmp95_;
													ValaMethodCall* contains_call;
													contains_method = (_tmp85_ = vala_data_type_get_member (vala_expression_get_value_type (vala_binary_expression_get_right (self)), "contains"), VALA_IS_METHOD (_tmp85_) ? ((ValaMethod*) _tmp85_) : NULL);
													if (contains_method == NULL) {
														char* _tmp86_;
														char* _tmp87_;
														vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), _tmp87_ = g_strdup_printf ("`%s' does not have a `contains' method", _tmp86_ = vala_code_node_to_string ((ValaCodeNode*) vala_expression_get_value_type (vala_binary_expression_get_right (self)))));
														_g_free0 (_tmp87_);
														_g_free0 (_tmp86_);
														vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
														result = FALSE;
													...
													if ((_tmp89_ = vala_collection_get_size ((ValaCollection*) (_tmp88_ = vala_method_get_parameters (contains_method))) != 1, _vala_collection_object_unref0 (_tmp88_), _tmp89_)) {
														char* _tmp90_;
														char* _tmp91_;
														vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), _tmp91_ = g_strdup_printf ("`%s' must have one parameter", _tmp90_ = vala_symbol_get_full_name ((ValaSymbol*) contains_method)));
														_g_free0 (_tmp91_);
														_g_free0 (_tmp90_);
														vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
														result = FALSE;
													...
													if (!vala_data_type_compatible (vala_method_get_return_type (contains_method), analyzer->bool_type)) {
														char* _tmp92_;
														char* _tmp93_;
														vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), _tmp93_ = g_strdup_printf ("`%s' must return a boolean value", _tmp92_ = vala_symbol_get_full_name ((ValaSymbol*) contains_method)));
														_g_free0 (_tmp93_);
														_g_free0 (_tmp92_);
														vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
														result = FALSE;
...
static void vala_binary_expression_real_emit (ValaCodeNode* base, ValaCodeGenerator* codegen) {
	...
	vala_code_node_emit ((ValaCodeNode*) vala_binary_expression_get_left (self), codegen);
	vala_code_node_emit ((ValaCodeNode*) vala_binary_expression_get_right (self), codegen);
