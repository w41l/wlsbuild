...
void vala_element_access_append_index (ValaElementAccess* self, ValaExpression* index) {
	...
	vala_collection_add ((ValaCollection*) self->priv->indices, index);
...
ValaList* vala_element_access_get_indices (ValaElementAccess* self) {
	...
	result = _vala_collection_object_ref0 (self->priv->indices);
	return result;
}
...
static void vala_element_access_real_accept_children (ValaCodeNode* base, ValaCodeVisitor* visitor) {
	...
	{
		ValaIterator* _e_it;
		_e_it = vala_iterable_iterator ((ValaIterable*) self->priv->indices);
		while (TRUE) {
			ValaExpression* e;
...
static void vala_element_access_real_replace_expression (ValaCodeNode* base, ValaExpression* old_node, ValaExpression* new_node) {
	...
	index = vala_list_index_of (self->priv->indices, old_node);
	if (index >= 0) {
	...
	if (_tmp0_) {
		vala_list_set (self->priv->indices, index, new_node);
...
static gboolean vala_element_access_real_is_pure (ValaExpression* base) {
	...
	self = (ValaElementAccess*) base;
	{
		...
		_index_it = vala_iterable_iterator ((ValaIterable*) self->priv->indices);
		while (TRUE) {
	...
	result = vala_expression_is_pure (vala_element_access_get_container (self));
	return result;
}
...
static gboolean vala_element_access_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer) {
	...
	if (!vala_code_node_check ((ValaCodeNode*) vala_element_access_get_container (self), analyzer)) {
	...
	if (vala_expression_get_value_type (vala_element_access_get_container (self)) == NULL) {
		vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
		vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) vala_element_access_get_container (self)), "Invalid container expression");
		result = FALSE;
		return result;
	}
	container_type = _vala_code_node_ref0 (vala_data_type_get_data_type (vala_expression_get_value_type (vala_element_access_get_container (self))));
	if (VALA_IS_MEMBER_ACCESS (vala_element_access_get_container (self))) {
		_tmp0_ = VALA_IS_SIGNAL (vala_expression_get_symbol_reference (vala_element_access_get_container (self)));
	} else {
		_tmp0_ = FALSE;
	}
	if (_tmp0_) {
		...
		ValaDataType* _tmp5_;
		if ((_tmp2_ = vala_collection_get_size ((ValaCollection*) (_tmp1_ = vala_element_access_get_indices (self))) != 1, _vala_collection_object_unref0 (_tmp1_), _tmp2_)) {
			vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
			vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), "Element access with more than one dimension is not supported for signa" \
"ls");
			result = FALSE;
			_vala_code_node_unref0 (container_type);
			return result;
		}
		vala_expression_set_target_type (_tmp4_ = (ValaExpression*) vala_list_get (_tmp3_ = vala_element_access_get_indices (self), 0), _tmp5_ = vala_data_type_copy (analyzer->string_type));
	...
	}
	{
		...
		ValaIterator* _tmp7_;
		ValaIterator* _index_it;
		_index_it = (_tmp7_ = vala_iterable_iterator ((ValaIterable*) (_tmp6_ = vala_element_access_get_indices (self))), _vala_collection_object_unref0 (_tmp6_), _tmp7_);
		while (TRUE) {
			ValaExpression* index;
			if (!vala_iterator_next (_index_it)) {
				break;
	...
	pointer_type = _vala_code_node_ref0 ((_tmp8_ = vala_expression_get_value_type (vala_element_access_get_container (self)), VALA_IS_POINTER_TYPE (_tmp8_) ? ((ValaPointerType*) _tmp8_) : NULL));
	if (VALA_IS_ARRAY_TYPE (vala_expression_get_value_type (vala_element_access_get_container (self)))) {
		ValaArrayType* array_type;
		ValaDataType* _tmp9_;
		array_type = _vala_code_node_ref0 (VALA_ARRAY_TYPE (vala_expression_get_value_type (vala_element_access_get_container (self))));
		vala_expression_set_value_type ((ValaExpression*) self, _tmp9_ = vala_data_type_copy (vala_array_type_get_element_type (array_type)));
		...
		if (pointer_type != NULL) {
			_tmp10_ = !vala_data_type_is_reference_type_or_type_parameter (vala_pointer_type_get_base_type (pointer_type));
		} else {
			_tmp10_ = FALSE;
		}
		if (_tmp10_) {
			ValaDataType* _tmp11_;
			vala_expression_set_value_type ((ValaExpression*) self, _tmp11_ = vala_data_type_copy (vala_pointer_type_get_base_type (pointer_type)));
			_vala_code_node_unref0 (_tmp11_);
		} else {
			gboolean _tmp12_ = FALSE;
			if (vala_code_context_get_profile (vala_semantic_analyzer_get_context (analyzer)) == VALA_PROFILE_GOBJECT) {
				_tmp12_ = container_type == vala_data_type_get_data_type (analyzer->string_type);
			} else {
				_tmp12_ = FALSE;
			}
			if (_tmp12_) {
				ValaList* _tmp13_;
				gboolean _tmp14_;
				if ((_tmp14_ = vala_collection_get_size ((ValaCollection*) (_tmp13_ = vala_element_access_get_indices (self))) != 1, _vala_collection_object_unref0 (_tmp13_), _tmp14_)) {
					vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
					vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), "Element access with more than one dimension is not supported for strin" \
"gs");
					result = FALSE;
				...
				if (vala_code_context_get_profile (vala_semantic_analyzer_get_context (analyzer)) == VALA_PROFILE_DOVA) {
					_tmp15_ = container_type == vala_data_type_get_data_type (analyzer->tuple_type);
				} else {
					_tmp15_ = FALSE;
				}
				if (_tmp15_) {
					...
					if ((_tmp17_ = vala_collection_get_size ((ValaCollection*) (_tmp16_ = vala_element_access_get_indices (self))) != 1, _vala_collection_object_unref0 (_tmp16_), _tmp17_)) {
						vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
						vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), "Element access with more than one dimension is not supported for tuple" \
"s");
						result = FALSE;
						_vala_code_node_unref0 (pointer_type);
						_vala_code_node_unref0 (container_type);
					...
					index = (_tmp20_ = (_tmp19_ = (ValaExpression*) vala_list_get (_tmp18_ = vala_element_access_get_indices (self), 0), VALA_IS_INTEGER_LITERAL (_tmp19_) ? ((ValaIntegerLiteral*) _tmp19_) : NULL), _vala_collection_object_unref0 (_tmp18_), _tmp20_);
					if (index == NULL) {
						vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
						vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), "Element access with non-literal index is not supported for tuples");
						result = FALSE;
						_vala_code_node_unref0 (index);
						_vala_code_node_unref0 (pointer_type);
						_vala_code_node_unref0 (container_type);
					...
					i = atoi (vala_integer_literal_get_value (index));
					if ((_tmp22_ = vala_collection_get_size ((ValaCollection*) (_tmp21_ = vala_data_type_get_type_arguments (vala_expression_get_value_type (vala_element_access_get_container (self))))) == 0, _vala_collection_object_unref0 (_tmp21_), _tmp22_)) {
						vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
						vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), "Element access is not supported for untyped tuples");
						result = FALSE;
						_vala_code_node_unref0 (index);
						_vala_code_node_unref0 (pointer_type);
						_vala_code_node_unref0 (container_type);
					...
					if (i < 0) {
						...
						ValaList* _tmp24_;
						_tmp23_ = i >= vala_collection_get_size ((ValaCollection*) (_tmp24_ = vala_data_type_get_type_arguments (vala_expression_get_value_type (vala_element_access_get_container (self)))));
						_vala_collection_object_unref0 (_tmp24_);
					}
					if (_tmp23_) {
						vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
						vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), "Index out of range");
						result = FALSE;
						_vala_code_node_unref0 (index);
						_vala_code_node_unref0 (pointer_type);
						_vala_code_node_unref0 (container_type);
					...
					result = vala_code_node_check ((ValaCodeNode*) get_call, analyzer);
					...
					if (VALA_IS_MEMBER_ACCESS (vala_element_access_get_container (self))) {
						_tmp27_ = VALA_IS_SIGNAL (vala_expression_get_symbol_reference (vala_element_access_get_container (self)));
					} else {
						_tmp27_ = FALSE;
					}
					if (_tmp27_) {
						...
						if (vala_expression_get_lvalue ((ValaExpression*) self)) {
							...
							set_method = (_tmp28_ = vala_data_type_get_member (vala_expression_get_value_type (vala_element_access_get_container (self)), "set"), VALA_IS_METHOD (_tmp28_) ? ((ValaMethod*) _tmp28_) : NULL);
							assignment = _vala_code_node_ref0 ((_tmp29_ = vala_code_node_get_parent_node ((ValaCodeNode*) self), VALA_IS_ASSIGNMENT (_tmp29_) ? ((ValaAssignment*) _tmp29_) : NULL));
							if (set_method != NULL) {
								_tmp31_ = VALA_IS_VOID_TYPE (vala_method_get_return_type (set_method));
							} else {
								_tmp31_ = FALSE;
							}
							if (_tmp31_) {
								_tmp30_ = assignment != NULL;
							} else {
								_tmp30_ = FALSE;
							}
							if (_tmp30_) {
							...
							get_method = (_tmp32_ = vala_data_type_get_member (vala_expression_get_value_type (vala_element_access_get_container (self)), "get"), VALA_IS_METHOD (_tmp32_) ? ((ValaMethod*) _tmp32_) : NULL);
							if (get_method != NULL) {
								...
								get_call = (_tmp34_ = vala_method_call_new ((ValaExpression*) (_tmp33_ = vala_member_access_new (vala_element_access_get_container (self), "get", vala_code_node_get_source_reference ((ValaCodeNode*) self))), vala_code_node_get_source_reference ((ValaCodeNode*) self)), _vala_code_node_unref0 (_tmp33_), _tmp34_);
								{
									...
									ValaIterator* _e_it;
									_e_it = (_tmp36_ = vala_iterable_iterator ((ValaIterable*) (_tmp35_ = vala_element_access_get_indices (self))), _vala_collection_object_unref0 (_tmp35_), _tmp36_);
									while (TRUE) {
										ValaExpression* e;
										if (!vala_iterator_next (_e_it)) {
											break;
										...
										e = (ValaExpression*) vala_iterator_get (_e_it);
										vala_method_call_add_argument (get_call, e);
										_vala_code_node_unref0 (e);
									}
									_vala_collection_object_unref0 (_e_it);
								}
								vala_expression_set_formal_target_type ((ValaExpression*) get_call, vala_expression_get_formal_target_type ((ValaExpression*) self));
								vala_expression_set_target_type ((ValaExpression*) get_call, vala_expression_get_target_type ((ValaExpression*) self));
								vala_code_node_replace_expression (vala_code_node_get_parent_node ((ValaCodeNode*) self), (ValaExpression*) self, (ValaExpression*) get_call);
								result = vala_code_node_check ((ValaCodeNode*) get_call, analyzer);
								_vala_code_node_unref0 (get_call);
						...
						vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
						vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), _tmp38_ = g_strdup_printf ("The expression `%s' does not denote an array", _tmp37_ = vala_code_node_to_string ((ValaCodeNode*) vala_expression_get_value_type (vala_element_access_get_container (self)))));
						_g_free0 (_tmp38_);
						_g_free0 (_tmp37_);
					}
				}
	...
	if (index_int_type_check) {
		{
			...
			ValaIterator* _e_it;
			_e_it = (_tmp40_ = vala_iterable_iterator ((ValaIterable*) (_tmp39_ = vala_element_access_get_indices (self))), _vala_collection_object_unref0 (_tmp39_), _tmp40_);
			while (TRUE) {
				ValaExpression* e;
				...
				if (VALA_IS_INTEGER_TYPE (vala_expression_get_value_type (e))) {
					...
					_tmp41_ = VALA_IS_ENUM_VALUE_TYPE (vala_expression_get_value_type (e));
				}
				if (!_tmp41_) {
					vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
...
static void vala_element_access_real_emit (ValaCodeNode* base, ValaCodeGenerator* codegen) {
	...
	vala_code_node_emit ((ValaCodeNode*) vala_element_access_get_container (self), codegen);
	{
		ValaIterator* _e_it;
		_e_it = vala_iterable_iterator ((ValaIterable*) self->priv->indices);
		while (TRUE) {
...
static void vala_element_access_instance_init (ValaElementAccess * self) {
	...
	self->priv->indices = (ValaList*) vala_array_list_new (VALA_TYPE_EXPRESSION, (GBoxedCopyFunc) vala_code_node_ref, vala_code_node_unref, g_direct_equal);
}
...
static void vala_element_access_finalize (ValaCodeNode* obj) {
	...
	_vala_collection_object_unref0 (self->priv->indices);
