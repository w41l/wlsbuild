...
static gboolean vala_catch_clause_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer);
...
static void vala_catch_clause_real_accept_children (ValaCodeNode* base, ValaCodeVisitor* visitor) {
	...
	self = (ValaCatchClause*) base;
	g_return_if_fail (visitor != NULL);
	if (vala_catch_clause_get_error_type (self) != NULL) {
		vala_code_node_accept ((ValaCodeNode*) vala_catch_clause_get_error_type (self), visitor);
	}
	vala_code_node_accept ((ValaCodeNode*) vala_catch_clause_get_body (self), visitor);
}
...
static void vala_catch_clause_real_replace_type (ValaCodeNode* base, ValaDataType* old_type, ValaDataType* new_type) {
	...
	if (vala_catch_clause_get_error_type (self) == old_type) {
...
static gboolean vala_catch_clause_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer) {
	...
	if (vala_catch_clause_get_error_type (self) != NULL) {
		...
		vala_catch_clause_set_error_variable (self, _tmp1_ = vala_local_variable_new (_tmp0_ = vala_data_type_copy (vala_catch_clause_get_error_type (self)), self->priv->_variable_name, NULL, NULL));
		_vala_code_node_unref0 (_tmp1_);
		_vala_code_node_unref0 (_tmp0_);
		vala_scope_add (vala_symbol_get_scope ((ValaSymbol*) vala_catch_clause_get_body (self)), self->priv->_variable_name, (ValaSymbol*) vala_catch_clause_get_error_variable (self));
		vala_block_add_local_variable (vala_catch_clause_get_body (self), vala_catch_clause_get_error_variable (self));
		vala_code_node_set_checked ((ValaCodeNode*) vala_catch_clause_get_error_variable (self), TRUE);
	} else {
		if (vala_code_context_get_profile (vala_semantic_analyzer_get_context (analyzer)) == VALA_PROFILE_GOBJECT) {
			ValaErrorType* _tmp2_;
			vala_catch_clause_set_error_type (self, (ValaDataType*) (_tmp2_ = vala_error_type_new (NULL, NULL, vala_code_node_get_source_reference ((ValaCodeNode*) self))));
			_vala_code_node_unref0 (_tmp2_);
		} else {
			vala_catch_clause_set_error_type (self, analyzer->error_type);
		}
	}
	vala_code_node_check ((ValaCodeNode*) vala_catch_clause_get_error_type (self), analyzer);
	vala_code_node_check ((ValaCodeNode*) vala_catch_clause_get_body (self), analyzer);
	result = !vala_code_node_get_error ((ValaCodeNode*) self);
	return result;
}
...
static void vala_catch_clause_real_emit (ValaCodeNode* base, ValaCodeGenerator* codegen) {
	...
	if (vala_catch_clause_get_error_variable (self) != NULL) {
		vala_symbol_set_active ((ValaSymbol*) vala_catch_clause_get_error_variable (self), TRUE);
	}
...
static void vala_catch_clause_real_get_defined_variables (ValaCodeNode* base, ValaCollection* collection) {
	...
	if (vala_catch_clause_get_error_variable (self) != NULL) {
		vala_collection_add (collection, vala_catch_clause_get_error_variable (self));
	}
}
...
ValaLocalVariable* vala_catch_clause_get_error_variable (ValaCatchClause* self) {
	...
	g_return_val_if_fail (self != NULL, NULL);
	result = self->priv->_error_variable;
	return result;
}
...
void vala_catch_clause_set_error_variable (ValaCatchClause* self, ValaLocalVariable* value) {
	...
	g_return_if_fail (self != NULL);
	self->priv->_error_variable = (_tmp0_ = _vala_code_node_ref0 (value), _vala_code_node_unref0 (self->priv->_error_variable), _tmp0_);
	vala_code_node_set_parent_node ((ValaCodeNode*) self->priv->_error_variable, (ValaCodeNode*) self);
}
...
void vala_catch_clause_set_clabel_name (ValaCatchClause* self, const char* value) {
	char* _tmp0_;
	g_return_if_fail (self != NULL);
	self->priv->_clabel_name = (_tmp0_ = g_strdup (value), _g_free0 (self->priv->_clabel_name), _tmp0_);
}
