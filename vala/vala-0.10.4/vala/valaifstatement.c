...
static gboolean vala_if_statement_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer);
...
static void vala_if_statement_real_accept_children (ValaCodeNode* base, ValaCodeVisitor* visitor) {
	...
	self = (ValaIfStatement*) base;
	g_return_if_fail (visitor != NULL);
	vala_code_node_accept ((ValaCodeNode*) vala_if_statement_get_condition (self), visitor);
	vala_code_visitor_visit_end_full_expression (visitor, vala_if_statement_get_condition (self));
	vala_code_node_accept ((ValaCodeNode*) vala_if_statement_get_true_statement (self), visitor);
	if (vala_if_statement_get_false_statement (self) != NULL) {
		vala_code_node_accept ((ValaCodeNode*) vala_if_statement_get_false_statement (self), visitor);
	}
}
...
static gboolean vala_if_statement_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer) {
	...
	vala_expression_set_target_type (vala_if_statement_get_condition (self), _tmp0_ = vala_data_type_copy (analyzer->bool_type));
	_vala_code_node_unref0 (_tmp0_);
	vala_code_node_check ((ValaCodeNode*) vala_if_statement_get_condition (self), analyzer);
	vala_code_node_check ((ValaCodeNode*) vala_if_statement_get_true_statement (self), analyzer);
	if (vala_if_statement_get_false_statement (self) != NULL) {
		vala_code_node_check ((ValaCodeNode*) vala_if_statement_get_false_statement (self), analyzer);
	}
	if (vala_code_node_get_error ((ValaCodeNode*) vala_if_statement_get_condition (self))) {
		vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
		result = FALSE;
		return result;
	}
	if (vala_expression_get_value_type (vala_if_statement_get_condition (self)) == NULL) {
		_tmp1_ = TRUE;
	} else {
		_tmp1_ = !vala_data_type_compatible (vala_expression_get_value_type (vala_if_statement_get_condition (self)), analyzer->bool_type);
	}
	if (_tmp1_) {
		vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
		vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) vala_if_statement_get_condition (self)), "Condition must be boolean");
		result = FALSE;
		return result;
	}
	vala_code_node_add_error_types ((ValaCodeNode*) self, _tmp2_ = vala_code_node_get_error_types ((ValaCodeNode*) vala_if_statement_get_condition (self)));
	_vala_collection_object_unref0 (_tmp2_);
	vala_code_node_add_error_types ((ValaCodeNode*) self, _tmp3_ = vala_code_node_get_error_types ((ValaCodeNode*) vala_if_statement_get_true_statement (self)));
	_vala_collection_object_unref0 (_tmp3_);
	if (vala_if_statement_get_false_statement (self) != NULL) {
		ValaList* _tmp4_;
		vala_code_node_add_error_types ((ValaCodeNode*) self, _tmp4_ = vala_code_node_get_error_types ((ValaCodeNode*) vala_if_statement_get_false_statement (self)));
...
static void vala_if_statement_real_emit (ValaCodeNode* base, ValaCodeGenerator* codegen) {
	...
	vala_code_node_emit ((ValaCodeNode*) vala_if_statement_get_condition (self), codegen);
	vala_code_visitor_visit_end_full_expression ((ValaCodeVisitor*) codegen, vala_if_statement_get_condition (self));
...
void vala_if_statement_set_true_statement (ValaIfStatement* self, ValaBlock* value) {
	ValaBlock* _tmp0_;
	g_return_if_fail (self != NULL);
	self->priv->_true_statement = (_tmp0_ = _vala_code_node_ref0 (value), _vala_code_node_unref0 (self->priv->_true_statement), _tmp0_);
	vala_code_node_set_parent_node ((ValaCodeNode*) self->priv->_true_statement, (ValaCodeNode*) self);
}
...
void vala_if_statement_set_false_statement (ValaIfStatement* self, ValaBlock* value) {
	ValaBlock* _tmp0_;
	g_return_if_fail (self != NULL);
	self->priv->_false_statement = (_tmp0_ = _vala_code_node_ref0 (value), _vala_code_node_unref0 (self->priv->_false_statement), _tmp0_);
	if (self->priv->_false_statement != NULL) {
		vala_code_node_set_parent_node ((ValaCodeNode*) self->priv->_false_statement, (ValaCodeNode*) self);
	}
}
