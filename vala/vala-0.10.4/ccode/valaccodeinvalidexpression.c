...
enum  {
	VALA_CCODE_INVALID_EXPRESSION_DUMMY_PROPERTY
};
...
static void vala_ccode_invalid_expression_real_write (ValaCCodeNode* base, ValaCCodeWriter* writer);
...
static void vala_ccode_invalid_expression_instance_init (ValaCCodeInvalidExpression * self) {
}
