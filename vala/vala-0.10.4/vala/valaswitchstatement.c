...
static gboolean vala_switch_statement_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer);
...
void vala_switch_statement_add_section (ValaSwitchStatement* self, ValaSwitchSection* section) {
	...
	vala_collection_add ((ValaCollection*) self->priv->sections, section);
}
...
ValaList* vala_switch_statement_get_sections (ValaSwitchStatement* self) {
	...
	result = _vala_collection_object_ref0 (self->priv->sections);
	return result;
}
...
static void vala_switch_statement_real_accept_children (ValaCodeNode* base, ValaCodeVisitor* visitor) {
	...
	vala_code_visitor_visit_end_full_expression (visitor, vala_switch_statement_get_expression (self));
	{
		...
		_section_it = vala_iterable_iterator ((ValaIterable*) self->priv->sections);
		while (TRUE) {
...
static gboolean vala_switch_statement_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer) {
	...
	if (!vala_code_node_check ((ValaCodeNode*) vala_switch_statement_get_expression (self), analyzer)) {
		vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
		result = FALSE;
		return result;
	}
	if (vala_expression_get_value_type (vala_switch_statement_get_expression (self)) == NULL) {
		_tmp0_ = TRUE;
	} else {
		gboolean _tmp1_ = FALSE;
		gboolean _tmp2_ = FALSE;
		if (!VALA_IS_INTEGER_TYPE (vala_expression_get_value_type (vala_switch_statement_get_expression (self)))) {
			_tmp2_ = !VALA_IS_ENUM_VALUE_TYPE (vala_expression_get_value_type (vala_switch_statement_get_expression (self)));
		} else {
			_tmp2_ = FALSE;
		}
		if (_tmp2_) {
			_tmp1_ = !vala_data_type_compatible (vala_expression_get_value_type (vala_switch_statement_get_expression (self)), analyzer->string_type);
		} else {
			_tmp1_ = FALSE;
		}
		_tmp0_ = _tmp1_;
	...
	if (_tmp0_) {
		vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) vala_switch_statement_get_expression (self)), "Integer or string expression expected");
		vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
		result = FALSE;
		return result;
	}
	vala_expression_set_target_type (vala_switch_statement_get_expression (self), _tmp3_ = vala_data_type_copy (vala_expression_get_value_type (vala_switch_statement_get_expression (self))));
	_vala_code_node_unref0 (_tmp3_);
	labelset = vala_hash_set_new (G_TYPE_STRING, (GBoxedCopyFunc) g_strdup, g_free, g_str_hash, g_str_equal);
	{
		ValaIterator* _section_it;
		_section_it = vala_iterable_iterator ((ValaIterable*) self->priv->sections);
		while (TRUE) {
			...
			section = (ValaSwitchSection*) vala_iterator_get (_section_it);
			vala_code_node_check ((ValaCodeNode*) section, analyzer);
			{
				ValaList* _tmp4_;
				ValaIterator* _tmp5_;
				ValaIterator* _label_it;
				_label_it = (_tmp5_ = vala_iterable_iterator ((ValaIterable*) (_tmp4_ = vala_switch_section_get_labels (section))), _vala_collection_object_unref0 (_tmp4_), _tmp5_);
				while (TRUE) {
					...
					value = NULL;
					if (VALA_IS_STRING_LITERAL (vala_switch_label_get_expression (label))) {
						char* _tmp6_;
						value = (_tmp6_ = vala_string_literal_eval (VALA_STRING_LITERAL (vala_switch_label_get_expression (label))), _g_free0 (value), _tmp6_);
					} else {
						if (VALA_IS_LITERAL (vala_switch_label_get_expression (label))) {
							char* _tmp7_;
							value = (_tmp7_ = vala_code_node_to_string ((ValaCodeNode*) VALA_LITERAL (vala_switch_label_get_expression (label))), _g_free0 (value), _tmp7_);
						}
					}
					if (value != NULL) {
						_tmp8_ = !vala_collection_add ((ValaCollection*) labelset, value);
					} else {
						_tmp8_ = FALSE;
					}
					if (_tmp8_) {
						vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
						vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) vala_switch_label_get_expression (label)), "Switch statement already contains this label");
					}
					_g_free0 (value);
			...
			vala_code_node_add_error_types ((ValaCodeNode*) self, _tmp9_ = vala_code_node_get_error_types ((ValaCodeNode*) section));
	...
	result = !vala_code_node_get_error ((ValaCodeNode*) self);
	_vala_collection_object_unref0 (labelset);
	return result;
}
...
static void vala_switch_statement_real_emit (ValaCodeNode* base, ValaCodeGenerator* codegen) {
	...
	vala_code_node_emit ((ValaCodeNode*) vala_switch_statement_get_expression (self), codegen);
	vala_code_visitor_visit_end_full_expression ((ValaCodeVisitor*) codegen, vala_switch_statement_get_expression (self));
...
static void vala_switch_statement_instance_init (ValaSwitchStatement * self) {
	...
	self->priv->sections = (ValaList*) vala_array_list_new (VALA_TYPE_SWITCH_SECTION, (GBoxedCopyFunc) vala_code_node_ref, vala_code_node_unref, g_direct_equal);
}
...
static void vala_switch_statement_finalize (ValaCodeNode* obj) {
	...
	_vala_collection_object_unref0 (self->priv->sections);
