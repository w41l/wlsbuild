...
static gboolean vala_foreach_statement_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer) {
	...
	vala_expression_set_target_type (vala_foreach_statement_get_collection (self), _tmp0_ = vala_data_type_copy (collection_type));
	...
	if (vala_code_context_get_profile (vala_semantic_analyzer_get_context (analyzer)) != VALA_PROFILE_DOVA) {
		_tmp1_ = vala_data_type_is_array (collection_type);
	} else {
		_tmp1_ = FALSE;
	}
	if (_tmp1_) {
		...
		if (vala_code_context_get_profile (vala_semantic_analyzer_get_context (analyzer)) == VALA_PROFILE_GOBJECT) {
			...
			if (vala_data_type_compatible (collection_type, analyzer->glist_type)) {
				...
				_tmp3_ = vala_data_type_compatible (collection_type, analyzer->gslist_type);
			}
			_tmp2_ = _tmp3_;
		} else {
			_tmp2_ = FALSE;
		...
		if (_tmp2_) {
			...
			ValaDataType* _tmp7_;
			gboolean _tmp8_;
			if ((_tmp5_ = vala_collection_get_size ((ValaCollection*) (_tmp4_ = vala_data_type_get_type_arguments (collection_type))) != 1, _vala_collection_object_unref0 (_tmp4_), _tmp5_)) {
				vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
			...
			result = (_tmp8_ = vala_foreach_statement_check_without_iterator (self, analyzer, collection_type, _tmp7_ = (ValaDataType*) vala_list_get (_tmp6_ = vala_data_type_get_type_arguments (collection_type), 0)), _vala_code_node_unref0 (_tmp7_), _vala_collection_object_unref0 (_tmp6_), _tmp8_);
			_vala_code_node_unref0 (collection_type);
			return result;
		} else {
			gboolean _tmp9_ = FALSE;
			if (vala_code_context_get_profile (vala_semantic_analyzer_get_context (analyzer)) == VALA_PROFILE_GOBJECT) {
				_tmp9_ = vala_data_type_compatible (collection_type, analyzer->gvaluearray_type);
			} else {
				_tmp9_ = FALSE;
			}
			if (_tmp9_) {
				result = vala_foreach_statement_check_without_iterator (self, analyzer, collection_type, (ValaDataType*) analyzer->gvalue_type);
				_vala_code_node_unref0 (collection_type);
				return result;
			} else {
				result = vala_foreach_statement_check_with_iterator (self, analyzer, collection_type);
				_vala_code_node_unref0 (collection_type);
				return result;
			}
		}
...
static gboolean vala_foreach_statement_check_with_iterator (ValaForeachStatement* self, ValaSemanticAnalyzer* analyzer, ValaDataType* collection_type) {
	...
	iterator_method = (_tmp0_ = vala_data_type_get_member (collection_type, "iterator"), VALA_IS_METHOD (_tmp0_) ? ((ValaMethod*) _tmp0_) : NULL);
	if (iterator_method == NULL) {
		char* _tmp1_;
		char* _tmp2_;
		vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) vala_foreach_statement_get_collection (self)), _tmp2_ = g_strdup_printf ("`%s' does not have an `iterator' method", _tmp1_ = vala_code_node_to_string ((ValaCodeNode*) collection_type)));
		_g_free0 (_tmp2_);
		_g_free0 (_tmp1_);
		vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
		result = FALSE;
	...
	if ((_tmp4_ = vala_collection_get_size ((ValaCollection*) (_tmp3_ = vala_method_get_parameters (iterator_method))) != 0, _vala_collection_object_unref0 (_tmp3_), _tmp4_)) {
		char* _tmp5_;
		char* _tmp6_;
		vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) vala_foreach_statement_get_collection (self)), _tmp6_ = g_strdup_printf ("`%s' must not have any parameters", _tmp5_ = vala_symbol_get_full_name ((ValaSymbol*) iterator_method)));
		_g_free0 (_tmp6_);
		_g_free0 (_tmp5_);
		vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
		result = FALSE;
	...
	iterator_type = vala_data_type_get_actual_type (vala_method_get_return_type (iterator_method), collection_type, NULL, (ValaCodeNode*) self);
	if (VALA_IS_VOID_TYPE (iterator_type)) {
		char* _tmp7_;
		char* _tmp8_;
		vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) vala_foreach_statement_get_collection (self)), _tmp8_ = g_strdup_printf ("`%s' must return an iterator", _tmp7_ = vala_symbol_get_full_name ((ValaSymbol*) iterator_method)));
		_g_free0 (_tmp8_);
		_g_free0 (_tmp7_);
		vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
		result = FALSE;
	...
	iterator_call = (_tmp10_ = vala_method_call_new ((ValaExpression*) (_tmp9_ = vala_member_access_new (vala_foreach_statement_get_collection (self), "iterator", vala_code_node_get_source_reference ((ValaCodeNode*) self))), vala_code_node_get_source_reference ((ValaCodeNode*) self)), _vala_code_node_unref0 (_tmp9_), _tmp10_);
	vala_block_add_statement ((ValaBlock*) self, (ValaStatement*) (_tmp13_ = vala_declaration_statement_new ((ValaSymbol*) (_tmp12_ = vala_local_variable_new (iterator_type, _tmp11_ = g_strdup_printf ("_%s_it", self->priv->_variable_name), (ValaExpression*) iterator_call, vala_code_node_get_source_reference ((ValaCodeNode*) self))), vala_code_node_get_source_reference ((ValaCodeNode*) self))));
	_vala_code_node_unref0 (_tmp13_);
	_vala_code_node_unref0 (_tmp12_);
	_g_free0 (_tmp11_);
	next_value_method = (_tmp14_ = vala_data_type_get_member (iterator_type, "next_value"), VALA_IS_METHOD (_tmp14_) ? ((ValaMethod*) _tmp14_) : NULL);
	next_method = (_tmp15_ = vala_data_type_get_member (iterator_type, "next"), VALA_IS_METHOD (_tmp15_) ? ((ValaMethod*) _tmp15_) : NULL);
	if (next_value_method != NULL) {
		...
		ValaNullLiteral* _tmp30_;
		ValaBinaryExpression* _tmp31_;
		ValaBinaryExpression* conditional;
		ValaWhileStatement* loop;
		if ((_tmp17_ = vala_collection_get_size ((ValaCollection*) (_tmp16_ = vala_method_get_parameters (next_value_method))) != 0, _vala_collection_object_unref0 (_tmp16_), _tmp17_)) {
			char* _tmp18_;
			char* _tmp19_;
			vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) vala_foreach_statement_get_collection (self)), _tmp19_ = g_strdup_printf ("`%s' must not have any parameters", _tmp18_ = vala_symbol_get_full_name ((ValaSymbol*) next_value_method)));
			_g_free0 (_tmp19_);
			_g_free0 (_tmp18_);
			vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
			result = FALSE;
		...
		element_type = vala_data_type_get_actual_type (vala_method_get_return_type (next_value_method), iterator_type, NULL, (ValaCodeNode*) self);
		if (!vala_data_type_get_nullable (element_type)) {
			char* _tmp20_;
			char* _tmp21_;
			vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) vala_foreach_statement_get_collection (self)), _tmp21_ = g_strdup_printf ("return type of `%s' must be nullable", _tmp20_ = vala_symbol_get_full_name ((ValaSymbol*) next_value_method)));
			_g_free0 (_tmp21_);
			_g_free0 (_tmp20_);
			vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
			result = FALSE;
		...
		if (!vala_foreach_statement_analyze_element_type (self, element_type)) {
			result = FALSE;
			_vala_code_node_unref0 (element_type);
			_vala_code_node_unref0 (next_method);
			_vala_code_node_unref0 (next_value_method);
		...
		vala_block_add_statement ((ValaBlock*) self, (ValaStatement*) (_tmp23_ = vala_declaration_statement_new ((ValaSymbol*) (_tmp22_ = vala_local_variable_new (vala_foreach_statement_get_type_reference (self), self->priv->_variable_name, NULL, vala_code_node_get_source_reference ((ValaCodeNode*) self))), vala_code_node_get_source_reference ((ValaCodeNode*) self))));
		_vala_code_node_unref0 (_tmp23_);
		_vala_code_node_unref0 (_tmp22_);
		next_value_call = (_tmp27_ = vala_method_call_new ((ValaExpression*) (_tmp26_ = vala_member_access_new ((ValaExpression*) (_tmp25_ = vala_member_access_new_simple (_tmp24_ = g_strdup_printf ("_%s_it", self->priv->_variable_name), vala_code_node_get_source_reference ((ValaCodeNode*) self))), "next_value", vala_code_node_get_source_reference ((ValaCodeNode*) self))), vala_code_node_get_source_reference ((ValaCodeNode*) self)), _vala_code_node_unref0 (_tmp26_), _vala_code_node_unref0 (_tmp25_), _g_free0 (_tmp24_), _tmp27_);
		assignment = (_tmp29_ = vala_assignment_new ((ValaExpression*) (_tmp28_ = vala_member_access_new (NULL, self->priv->_variable_name, vala_code_node_get_source_reference ((ValaCodeNode*) self))), (ValaExpression*) next_value_call, VALA_ASSIGNMENT_OPERATOR_SIMPLE, vala_code_node_get_source_reference ((ValaCodeNode*) self)), _vala_code_node_unref0 (_tmp28_), _tmp29_);
		conditional = (_tmp31_ = vala_binary_expression_new (VALA_BINARY_OPERATOR_INEQUALITY, (ValaExpression*) assignment, (ValaExpression*) (_tmp30_ = vala_null_literal_new (vala_code_node_get_source_reference ((ValaCodeNode*) self))), vala_code_node_get_source_reference ((ValaCodeNode*) self)), _vala_code_node_unref0 (_tmp30_), _tmp31_);
		loop = vala_while_statement_new ((ValaExpression*) conditional, vala_foreach_statement_get_body (self), vala_code_node_get_source_reference ((ValaCodeNode*) self));
		...
		if (next_method != NULL) {
			...
			ValaDeclarationStatement* _tmp56_;
			if ((_tmp33_ = vala_collection_get_size ((ValaCollection*) (_tmp32_ = vala_method_get_parameters (next_method))) != 0, _vala_collection_object_unref0 (_tmp32_), _tmp33_)) {
				char* _tmp34_;
				char* _tmp35_;
				vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) vala_foreach_statement_get_collection (self)), _tmp35_ = g_strdup_printf ("`%s' must not have any parameters", _tmp34_ = vala_symbol_get_full_name ((ValaSymbol*) next_method)));
				_g_free0 (_tmp35_);
				_g_free0 (_tmp34_);
				vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
				result = FALSE;
			...
			if (!vala_data_type_compatible (vala_method_get_return_type (next_method), analyzer->bool_type)) {
				char* _tmp36_;
				char* _tmp37_;
				vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) vala_foreach_statement_get_collection (self)), _tmp37_ = g_strdup_printf ("`%s' must return a boolean value", _tmp36_ = vala_symbol_get_full_name ((ValaSymbol*) next_method)));
				_g_free0 (_tmp37_);
				_g_free0 (_tmp36_);
				vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
				result = FALSE;
			...
			get_method = (_tmp38_ = vala_data_type_get_member (iterator_type, "get"), VALA_IS_METHOD (_tmp38_) ? ((ValaMethod*) _tmp38_) : NULL);
			if (get_method == NULL) {
				char* _tmp39_;
				char* _tmp40_;
				vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) vala_foreach_statement_get_collection (self)), _tmp40_ = g_strdup_printf ("`%s' does not have a `get' method", _tmp39_ = vala_code_node_to_string ((ValaCodeNode*) iterator_type)));
				_g_free0 (_tmp40_);
				_g_free0 (_tmp39_);
				vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
				result = FALSE;
			...
			if ((_tmp42_ = vala_collection_get_size ((ValaCollection*) (_tmp41_ = vala_method_get_parameters (get_method))) != 0, _vala_collection_object_unref0 (_tmp41_), _tmp42_)) {
				char* _tmp43_;
				char* _tmp44_;
				vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) vala_foreach_statement_get_collection (self)), _tmp44_ = g_strdup_printf ("`%s' must not have any parameters", _tmp43_ = vala_symbol_get_full_name ((ValaSymbol*) get_method)));
				_g_free0 (_tmp44_);
				_g_free0 (_tmp43_);
				vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
				result = FALSE;
			...
			element_type = vala_data_type_get_actual_type (vala_method_get_return_type (get_method), iterator_type, NULL, (ValaCodeNode*) self);
			if (VALA_IS_VOID_TYPE (element_type)) {
				char* _tmp45_;
				char* _tmp46_;
				vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) vala_foreach_statement_get_collection (self)), _tmp46_ = g_strdup_printf ("`%s' must return an element", _tmp45_ = vala_symbol_get_full_name ((ValaSymbol*) get_method)));
				_g_free0 (_tmp46_);
				_g_free0 (_tmp45_);
				vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
				result = FALSE;
			...
			next_call = (_tmp50_ = vala_method_call_new ((ValaExpression*) (_tmp49_ = vala_member_access_new ((ValaExpression*) (_tmp48_ = vala_member_access_new_simple (_tmp47_ = g_strdup_printf ("_%s_it", self->priv->_variable_name), vala_code_node_get_source_reference ((ValaCodeNode*) self))), "next", vala_code_node_get_source_reference ((ValaCodeNode*) self))), vala_code_node_get_source_reference ((ValaCodeNode*) self)), _vala_code_node_unref0 (_tmp49_), _vala_code_node_unref0 (_tmp48_), _g_free0 (_tmp47_), _tmp50_);
			...
			vala_block_add_statement ((ValaBlock*) self, (ValaStatement*) loop);
			get_call = (_tmp54_ = vala_method_call_new ((ValaExpression*) (_tmp53_ = vala_member_access_new ((ValaExpression*) (_tmp52_ = vala_member_access_new_simple (_tmp51_ = g_strdup_printf ("_%s_it", self->priv->_variable_name), vala_code_node_get_source_reference ((ValaCodeNode*) self))), "get", vala_code_node_get_source_reference ((ValaCodeNode*) self))), vala_code_node_get_source_reference ((ValaCodeNode*) self)), _vala_code_node_unref0 (_tmp53_), _vala_code_node_unref0 (_tmp52_), _g_free0 (_tmp51_), _tmp54_);
			vala_block_insert_statement (vala_foreach_statement_get_body (self), 0, (ValaStatement*) (_tmp56_ = vala_declaration_statement_new ((ValaSymbol*) (_tmp55_ = vala_local_variable_new (vala_foreach_statement_get_type_reference (self), self->priv->_variable_name, (ValaExpression*) get_call, vala_code_node_get_source_reference ((ValaCodeNode*) self))), vala_code_node_get_source_reference ((ValaCodeNode*) self))));
			...
			char* _tmp57_;
			char* _tmp58_;
			vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) vala_foreach_statement_get_collection (self)), _tmp58_ = g_strdup_printf ("`%s' does not have a `next_value' or `next' method", _tmp57_ = vala_code_node_to_string ((ValaCodeNode*) iterator_type)));
			_g_free0 (_tmp58_);
			_g_free0 (_tmp57_);
			vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
			result = FALSE;
	...
	result = VALA_CODE_NODE_CLASS (vala_foreach_statement_parent_class)->check ((ValaCodeNode*) VALA_BLOCK (self), analyzer);
	_vala_code_node_unref0 (next_method);
	_vala_code_node_unref0 (next_value_method);
	_vala_code_node_unref0 (iterator_call);
	_vala_code_node_unref0 (iterator_type);
...
static gboolean vala_foreach_statement_analyze_element_type (ValaForeachStatement* self, ValaDataType* element_type) {
	...
	if (vala_foreach_statement_get_type_reference (self) == NULL) {
		ValaDataType* _tmp0_;
		vala_foreach_statement_set_type_reference (self, _tmp0_ = vala_data_type_copy (element_type));
		_vala_code_node_unref0 (_tmp0_);
	} else {
		if (!vala_data_type_compatible (element_type, vala_foreach_statement_get_type_reference (self))) {
			...
			char* _tmp3_;
			vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
			vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), _tmp3_ = g_strdup_printf ("Foreach: Cannot convert from `%s' to `%s'", _tmp1_ = vala_code_node_to_string ((ValaCodeNode*) element_type), _tmp2_ = vala_code_node_to_string ((ValaCodeNode*) vala_foreach_statement_get_type_reference (self))));
			_g_free0 (_tmp3_);
			_g_free0 (_tmp2_);
			_g_free0 (_tmp1_);
			result = FALSE;
			...
			if (vala_data_type_is_disposable (element_type)) {
				_tmp5_ = vala_data_type_get_value_owned (element_type);
			} else {
				_tmp5_ = FALSE;
			}
			if (_tmp5_) {
				_tmp4_ = !vala_data_type_get_value_owned (vala_foreach_statement_get_type_reference (self));
			} else {
				_tmp4_ = FALSE;
			}
			if (_tmp4_) {
...
static gboolean vala_foreach_statement_check_without_iterator (ValaForeachStatement* self, ValaSemanticAnalyzer* analyzer, ValaDataType* collection_type, ValaDataType* element_type) {
	...
	vala_foreach_statement_set_element_variable (self, _tmp4_ = vala_local_variable_new (vala_foreach_statement_get_type_reference (self), self->priv->_variable_name, NULL, NULL));
	...
	vala_code_node_check ((ValaCodeNode*) vala_foreach_statement_get_body (self), analyzer);
	{
		...
		_local_it = (_tmp6_ = vala_iterable_iterator ((ValaIterable*) (_tmp5_ = vala_block_get_local_variables ((ValaBlock*) self))), _vala_collection_object_unref0 (_tmp5_), _tmp6_);
		while (TRUE) {
	...
	vala_foreach_statement_set_collection_variable (self, _tmp8_ = vala_local_variable_new (collection_type, _tmp7_ = g_strdup_printf ("%s_collection", self->priv->_variable_name), NULL, NULL));
	...
	vala_code_node_add_error_types ((ValaCodeNode*) self, _tmp9_ = vala_code_node_get_error_types ((ValaCodeNode*) vala_foreach_statement_get_collection (self)));
	_vala_collection_object_unref0 (_tmp9_);
	vala_code_node_add_error_types ((ValaCodeNode*) self, _tmp10_ = vala_code_node_get_error_types ((ValaCodeNode*) vala_foreach_statement_get_body (self)));
...
static void vala_foreach_statement_real_emit (ValaCodeNode* base, ValaCodeGenerator* codegen) {
	...
	vala_code_node_emit ((ValaCodeNode*) vala_foreach_statement_get_collection (self), codegen);
	vala_code_visitor_visit_end_full_expression ((ValaCodeVisitor*) codegen, vala_foreach_statement_get_collection (self));
	vala_symbol_set_active ((ValaSymbol*) self->priv->_element_variable, TRUE);
	vala_symbol_set_active ((ValaSymbol*) self->priv->_collection_variable, TRUE);
...
void vala_foreach_statement_set_variable_name (ValaForeachStatement* self, const char* value) {
	char* _tmp0_;
	g_return_if_fail (self != NULL);
	self->priv->_variable_name = (_tmp0_ = g_strdup (value), _g_free0 (self->priv->_variable_name), _tmp0_);
}
...
void vala_foreach_statement_set_collection (ValaForeachStatement* self, ValaExpression* value) {
	...
	g_return_if_fail (self != NULL);
	self->priv->_collection = (_tmp0_ = _vala_code_node_ref0 (value), _vala_code_node_unref0 (self->priv->_collection), _tmp0_);
...
void vala_foreach_statement_set_element_variable (ValaForeachStatement* self, ValaLocalVariable* value) {
	...
	g_return_if_fail (self != NULL);
	self->priv->_element_variable = (_tmp0_ = _vala_code_node_ref0 (value), _vala_code_node_unref0 (self->priv->_element_variable), _tmp0_);
}
...
void vala_foreach_statement_set_collection_variable (ValaForeachStatement* self, ValaLocalVariable* value) {
	ValaLocalVariable* _tmp0_;
	g_return_if_fail (self != NULL);
	self->priv->_collection_variable = (_tmp0_ = _vala_code_node_ref0 (value), _vala_code_node_unref0 (self->priv->_collection_variable), _tmp0_);
}
...
void vala_foreach_statement_set_iterator_variable (ValaForeachStatement* self, ValaLocalVariable* value) {
	ValaLocalVariable* _tmp0_;
	g_return_if_fail (self != NULL);
	self->priv->_iterator_variable = (_tmp0_ = _vala_code_node_ref0 (value), _vala_code_node_unref0 (self->priv->_iterator_variable), _tmp0_);
}
