...
ValaCreationMethod* vala_creation_method_construct (GType object_type, const char* class_name, const char* name, ValaSourceReference* source_reference, ValaComment* comment) {
	...
	ValaVoidType* _tmp0_;
	self = (ValaCreationMethod*) vala_method_construct (object_type, name, (ValaDataType*) (_tmp0_ = vala_void_type_new (NULL)), source_reference, comment);
...
static void vala_creation_method_real_accept_children (ValaCodeNode* base, ValaCodeVisitor* visitor) {
	...
	g_return_if_fail (visitor != NULL);
	{
		...
		_param_it = (_tmp1_ = vala_iterable_iterator ((ValaIterable*) (_tmp0_ = vala_method_get_parameters ((ValaMethod*) self))), _vala_collection_object_unref0 (_tmp0_), _tmp1_);
		while (TRUE) {
	...
	}
	{
		...
		_precondition_it = (_tmp5_ = vala_iterable_iterator ((ValaIterable*) (_tmp4_ = vala_method_get_preconditions ((ValaMethod*) self))), _vala_collection_object_unref0 (_tmp4_), _tmp5_);
		while (TRUE) {
	...
	}
	{
		...
		_postcondition_it = (_tmp7_ = vala_iterable_iterator ((ValaIterable*) (_tmp6_ = vala_method_get_postconditions ((ValaMethod*) self))), _vala_collection_object_unref0 (_tmp6_), _tmp7_);
		while (TRUE) {
...
static char* vala_creation_method_real_get_default_cname (ValaMethod* base) {
	...
	ValaStruct* st;
	self = (ValaCreationMethod*) base;
	parent = _vala_code_node_ref0 ((_tmp0_ = vala_symbol_get_parent_symbol ((ValaSymbol*) self), VALA_IS_TYPESYMBOL (_tmp0_) ? ((ValaTypeSymbol*) _tmp0_) : NULL));
	infix = g_strdup ("new");
	st = _vala_code_node_ref0 ((_tmp1_ = parent, VALA_IS_STRUCT (_tmp1_) ? ((ValaStruct*) _tmp1_) : NULL));
	if (st != NULL) {
		...
		if ((_tmp3_ = vala_code_context_get_profile (_tmp2_ = vala_code_context_get ()) == VALA_PROFILE_DOVA, _vala_code_context_unref0 (_tmp2_), _tmp3_)) {
			...
			if (_tmp5_) {
				...
				_tmp4_ = vala_struct_is_floating_type (st);
			}
			if (_tmp4_) {
				if (_vala_strcmp0 (vala_symbol_get_name ((ValaSymbol*) self), ".new") == 0) {
					result = vala_symbol_get_lower_case_cname ((ValaSymbol*) parent, NULL);
					...
					char* _tmp6_;
					char* _tmp7_;
					result = (_tmp7_ = g_strdup_printf ("%s%s", _tmp6_ = vala_symbol_get_lower_case_cprefix ((ValaSymbol*) parent), vala_symbol_get_name ((ValaSymbol*) self)), _g_free0 (_tmp6_), _tmp7_);
					_vala_code_node_unref0 (st);
					_g_free0 (infix);
					_vala_code_node_unref0 (parent);
					return result;
		...
		infix = (_tmp8_ = g_strdup ("init"), _g_free0 (infix), _tmp8_);
	}
	if (_vala_strcmp0 (vala_symbol_get_name ((ValaSymbol*) self), ".new") == 0) {
		char* _tmp9_;
		char* _tmp10_;
		result = (_tmp10_ = g_strdup_printf ("%s%s", _tmp9_ = vala_symbol_get_lower_case_cprefix ((ValaSymbol*) parent), infix), _g_free0 (_tmp9_), _tmp10_);
		_vala_code_node_unref0 (st);
		_g_free0 (infix);
		_vala_code_node_unref0 (parent);
		return result;
		...
		char* _tmp11_;
		char* _tmp12_;
		result = (_tmp12_ = g_strdup_printf ("%s%s_%s", _tmp11_ = vala_symbol_get_lower_case_cprefix ((ValaSymbol*) parent), infix, vala_symbol_get_name ((ValaSymbol*) self)), _g_free0 (_tmp11_), _tmp12_);
		_vala_code_node_unref0 (st);
		_g_free0 (infix);
		_vala_code_node_unref0 (parent);
		return result;
...
static char* vala_creation_method_real_get_real_cname (ValaMethod* base) {
	ValaCreationMethod * self;
	char* result = NULL;
	ValaAttribute* ccode_attribute;
	gboolean _tmp0_ = FALSE;
	self = (ValaCreationMethod*) base;
	ccode_attribute = vala_code_node_get_attribute ((ValaCodeNode*) self, "CCode");
	if (ccode_attribute != NULL) {
		_tmp0_ = vala_attribute_has_argument (ccode_attribute, "construct_function");
	} else {
		_tmp0_ = FALSE;
	}
	if (_tmp0_) {
		result = vala_attribute_get_string (ccode_attribute, "construct_function");
		_vala_code_node_unref0 (ccode_attribute);
		return result;
	}
	result = vala_creation_method_get_default_construct_function (self);
	_vala_code_node_unref0 (ccode_attribute);
	return result;
}
...
char* vala_creation_method_get_default_construct_function (ValaCreationMethod* self) {
	...
	parent = _vala_code_node_ref0 ((_tmp0_ = vala_symbol_get_parent_symbol ((ValaSymbol*) self), VALA_IS_CLASS (_tmp0_) ? ((ValaClass*) _tmp0_) : NULL));
	if (parent == NULL) {
		_tmp1_ = TRUE;
	} else {
		_tmp1_ = vala_class_get_is_compact (parent);
	}
	if (_tmp1_) {
		result = vala_method_get_cname ((ValaMethod*) self);
		_vala_code_node_unref0 (parent);
		return result;
	}
	...
	if ((_tmp3_ = vala_code_context_get_profile (_tmp2_ = vala_code_context_get ()) == VALA_PROFILE_DOVA, _vala_code_context_unref0 (_tmp2_), _tmp3_)) {
		char* _tmp4_;
		infix = (_tmp4_ = g_strdup ("init"), _g_free0 (infix), _tmp4_);
	}
	if (_vala_strcmp0 (vala_symbol_get_name ((ValaSymbol*) self), ".new") == 0) {
		char* _tmp5_;
		char* _tmp6_;
		result = (_tmp6_ = g_strdup_printf ("%s%s", _tmp5_ = vala_symbol_get_lower_case_cprefix ((ValaSymbol*) parent), infix), _g_free0 (_tmp5_), _tmp6_);
		_g_free0 (infix);
		_vala_code_node_unref0 (parent);
		return result;
	} else {
		char* _tmp7_;
		char* _tmp8_;
		result = (_tmp8_ = g_strdup_printf ("%s%s_%s", _tmp7_ = vala_symbol_get_lower_case_cprefix ((ValaSymbol*) parent), infix, vala_symbol_get_name ((ValaSymbol*) self)), _g_free0 (_tmp7_), _tmp8_);
		_g_free0 (infix);
		_vala_code_node_unref0 (parent);
		return result;
	}
...
static gboolean vala_creation_method_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer) {
	...
	if (self->priv->_class_name != NULL) {
		_tmp0_ = _vala_strcmp0 (self->priv->_class_name, vala_symbol_get_name (vala_symbol_get_parent_symbol ((ValaSymbol*) self))) != 0;
	} else {
		_tmp0_ = FALSE;
	}
	if (_tmp0_) {
		char* _tmp1_;
		char* _tmp2_;
		vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), _tmp2_ = g_strdup_printf ("missing return type in method `%s.%s´", _tmp1_ = vala_symbol_get_full_name (vala_semantic_analyzer_get_current_symbol (analyzer)), self->priv->_class_name));
		_g_free0 (_tmp2_);
		_g_free0 (_tmp1_);
	...
	vala_semantic_analyzer_set_current_symbol (analyzer, (ValaSymbol*) self);
	{
		...
		ValaIterator* _tmp4_;
		ValaIterator* _param_it;
		_param_it = (_tmp4_ = vala_iterable_iterator ((ValaIterable*) (_tmp3_ = vala_method_get_parameters ((ValaMethod*) self))), _vala_collection_object_unref0 (_tmp3_), _tmp4_);
		while (TRUE) {
			ValaFormalParameter* param;
			if (!vala_iterator_next (_param_it)) {
				break;
	...
	}
	{
		...
		ValaIterator* _tmp6_;
		ValaIterator* _error_type_it;
		_error_type_it = (_tmp6_ = vala_iterable_iterator ((ValaIterable*) (_tmp5_ = vala_code_node_get_error_types ((ValaCodeNode*) self))), _vala_collection_object_unref0 (_tmp5_), _tmp6_);
		while (TRUE) {
			ValaDataType* error_type;
			if (!vala_iterator_next (_error_type_it)) {
				break;
	...
	}
	{
		...
		ValaIterator* _tmp8_;
		ValaIterator* _precondition_it;
		_precondition_it = (_tmp8_ = vala_iterable_iterator ((ValaIterable*) (_tmp7_ = vala_method_get_preconditions ((ValaMethod*) self))), _vala_collection_object_unref0 (_tmp7_), _tmp8_);
		while (TRUE) {
			ValaExpression* precondition;
			if (!vala_iterator_next (_precondition_it)) {
				break;
	...
	}
	{
		...
		ValaIterator* _postcondition_it;
		_postcondition_it = (_tmp10_ = vala_iterable_iterator ((ValaIterable*) (_tmp9_ = vala_method_get_postconditions ((ValaMethod*) self))), _vala_collection_object_unref0 (_tmp9_), _tmp10_);
		while (TRUE) {
			ValaExpression* postcondition;
			if (!vala_iterator_next (_postcondition_it)) {
				break;
	...
	if (vala_method_get_body ((ValaMethod*) self) != NULL) {
		...
		cl = _vala_code_node_ref0 ((_tmp11_ = vala_symbol_get_parent_symbol ((ValaSymbol*) self), VALA_IS_CLASS (_tmp11_) ? ((ValaClass*) _tmp11_) : NULL));
		if (!self->priv->_chain_up) {
			_tmp13_ = cl != NULL;
		} else {
			_tmp13_ = FALSE;
		}
		if (_tmp13_) {
			_tmp12_ = vala_class_get_base_class (cl) != NULL;
		} else {
			_tmp12_ = FALSE;
		}
		if (_tmp12_) {
			...
			if (vala_code_context_get_profile (vala_semantic_analyzer_get_context (analyzer)) == VALA_PROFILE_GOBJECT) {
				_tmp15_ = vala_class_get_default_construction_method (vala_class_get_base_class (cl)) != NULL;
			} else {
				_tmp15_ = FALSE;
			}
			if (_tmp15_) {
				_tmp14_ = !vala_method_get_has_construct_function (vala_class_get_default_construction_method (vala_class_get_base_class (cl)));
			} else {
				_tmp14_ = FALSE;
			}
			if (_tmp14_) {
				...
				if (vala_class_get_default_construction_method (vala_class_get_base_class (cl)) == NULL) {
					_tmp16_ = TRUE;
				} else {
					_tmp16_ = vala_symbol_get_access ((ValaSymbol*) vala_class_get_default_construction_method (vala_class_get_base_class (cl))) == VALA_SYMBOL_ACCESSIBILITY_PRIVATE;
				}
				if (_tmp16_) {
					if (vala_code_context_get_profile (vala_semantic_analyzer_get_context (analyzer)) == VALA_PROFILE_GOBJECT) {
						vala_report_warning (vala_code_node_get_source_reference ((ValaCodeNode*) self), "unable to chain up to private base constructor");
					} else {
						vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), "unable to chain up to private base constructor");
					}
				} else {
					if (vala_method_get_required_arguments (vala_class_get_default_construction_method (vala_class_get_base_class (cl))) > 0) {
						if (vala_code_context_get_profile (vala_semantic_analyzer_get_context (analyzer)) == VALA_PROFILE_GOBJECT) {
							vala_report_warning (vala_code_node_get_source_reference ((ValaCodeNode*) self), "unable to chain up to base constructor requiring arguments");
						} else {
							vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), "unable to chain up to base constructor requiring arguments");
						}
					} else {
						ValaBlock* old_insert_block;
						ValaBlock* _tmp17_;
						ValaBaseAccess* _tmp18_;
						ValaMethodCall* _tmp19_;
						ValaExpressionStatement* _tmp20_;
						ValaExpressionStatement* stmt;
						ValaBlock* _tmp21_;
						old_insert_block = _vala_code_node_ref0 (analyzer->insert_block);
						vala_semantic_analyzer_set_current_symbol (analyzer, (ValaSymbol*) vala_method_get_body ((ValaMethod*) self));
						analyzer->insert_block = (_tmp17_ = _vala_code_node_ref0 (vala_method_get_body ((ValaMethod*) self)), _vala_code_node_unref0 (analyzer->insert_block), _tmp17_);
						stmt = (_tmp20_ = vala_expression_statement_new ((ValaExpression*) (_tmp19_ = vala_method_call_new ((ValaExpression*) (_tmp18_ = vala_base_access_new (vala_code_node_get_source_reference ((ValaCodeNode*) self))), vala_code_node_get_source_reference ((ValaCodeNode*) self))), vala_code_node_get_source_reference ((ValaCodeNode*) self)), _vala_code_node_unref0 (_tmp19_), _vala_code_node_unref0 (_tmp18_), _tmp20_);
						vala_block_insert_statement (vala_method_get_body ((ValaMethod*) self), 0, (ValaStatement*) stmt);
						vala_code_node_check ((ValaCodeNode*) stmt, analyzer);
						vala_semantic_analyzer_set_current_symbol (analyzer, (ValaSymbol*) self);
						analyzer->insert_block = (_tmp21_ = _vala_code_node_ref0 (old_insert_block), _vala_code_node_unref0 (analyzer->insert_block), _tmp21_);
	...
	if (vala_method_get_is_abstract ((ValaMethod*) self)) {
		...
		_tmp23_ = vala_method_get_is_virtual ((ValaMethod*) self);
	}
	if (_tmp23_) {
		_tmp22_ = TRUE;
	} else {
		_tmp22_ = vala_method_get_overrides ((ValaMethod*) self);
	}
	if (_tmp22_) {
		char* _tmp24_;
		char* _tmp25_;
		vala_report_error (vala_code_node_get_source_reference ((ValaCodeNode*) self), _tmp25_ = g_strdup_printf ("The creation method `%s' cannot be marked as override, virtual, or abs" \
"tract", _tmp24_ = vala_symbol_get_full_name ((ValaSymbol*) self)));
		_g_free0 (_tmp25_);
		_g_free0 (_tmp24_);
		result = FALSE;
	...
	if (vala_method_get_body ((ValaMethod*) self) != NULL) {
		{
			...
			_body_error_type_it = (_tmp27_ = vala_iterable_iterator ((ValaIterable*) (_tmp26_ = vala_code_node_get_error_types ((ValaCodeNode*) vala_method_get_body ((ValaMethod*) self)))), _vala_collection_object_unref0 (_tmp26_), _tmp27_);
			while (TRUE) {
				...
				can_propagate_error = FALSE;
				{
					...
					_method_error_type_it = (_tmp29_ = vala_iterable_iterator ((ValaIterable*) (_tmp28_ = vala_code_node_get_error_types ((ValaCodeNode*) self))), _vala_collection_object_unref0 (_tmp28_), _tmp29_);
					while (TRUE) {
				...
				if (!can_propagate_error) {
					_tmp30_ = !vala_error_type_get_dynamic_error (VALA_ERROR_TYPE (body_error_type));
				} else {
					_tmp30_ = FALSE;
				}
				if (_tmp30_) {
					char* _tmp31_;
					char* _tmp32_;
					vala_report_warning (vala_code_node_get_source_reference ((ValaCodeNode*) body_error_type), _tmp32_ = g_strdup_printf ("unhandled error `%s'", _tmp31_ = vala_code_node_to_string ((ValaCodeNode*) body_error_type)));
					_g_free0 (_tmp32_);
					_g_free0 (_tmp31_);
				}
...
void vala_creation_method_set_class_name (ValaCreationMethod* self, const char* value) {
	...
	self->priv->_class_name = (_tmp0_ = g_strdup (value), _g_free0 (self->priv->_class_name), _tmp0_);
}
...
const char* vala_creation_method_get_custom_return_type_cname (ValaCreationMethod* self) {
	const char* result;
	g_return_val_if_fail (self != NULL, NULL);
	result = self->priv->_custom_return_type_cname;
	return result;
}
...
void vala_creation_method_set_custom_return_type_cname (ValaCreationMethod* self, const char* value) {
	char* _tmp0_;
	g_return_if_fail (self != NULL);
	self->priv->_custom_return_type_cname = (_tmp0_ = g_strdup (value), _g_free0 (self->priv->_custom_return_type_cname), _tmp0_);
}
...
static void vala_creation_method_finalize (ValaCodeNode* obj) {
	...
	_g_free0 (self->priv->_custom_return_type_cname);
