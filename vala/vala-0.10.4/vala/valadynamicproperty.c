...
static ValaList* vala_dynamic_property_real_get_cheader_filenames (ValaSymbol* base);
static gboolean vala_dynamic_property_real_check (ValaCodeNode* base, ValaSemanticAnalyzer* analyzer);
